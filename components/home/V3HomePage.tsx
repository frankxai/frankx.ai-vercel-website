              ...
              <div className="text-center space-y-10">
                ...
                <StaggerItem>
                  <Pill
                    ...
                    className="mx-auto"
                  >
                    Built by AI Architect | 500+ Suno Sessions
                  </Pill>
                </StaggerItem>
                ...
                <StaggerItem>
                  <p className="text-body text-neutral-300 max-w-4xl mx-auto leading-relaxed">
                    ...
                    Plus Suno music workflows and systems-first creation architecture. Built by an AI Architect who's created 500+ songs.
                  </p>
                </StaggerItem>
