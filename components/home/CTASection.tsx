...
export function CTASection() {
  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 border-t border-white/[0.03] overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-grid-soft opacity-[0.2] pointer-events-none" />
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="relative rounded-[28px] border border-white/10 bg-white/[0.03] px-6 py-10 md:px-12 md:py-14 backdrop-blur-xl overflow-hidden">
            <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-emerald-500/10 via-cyan-500/10 to-transparent" />
            ...
            <div className="relative">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-emerald-400/60 mb-4">
                Start Here
              </p>
