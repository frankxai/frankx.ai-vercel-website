      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        >
          ...
          <motion.h1
            ...
            variants={shouldReduceMotion ? undefined : itemVariants}
          >
            <span className="block font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight text-white max-w-5xl mx-auto">
              {hero.headline}
            </span>
          </motion.h1>
          ...
          {/* Subheadline */}
          <motion.p
            className="text-lg sm:text-xl md:text-2xl text-white/60 max-w-3xl mx-auto mb-10 md:mb-12 leading-relaxed px-4"
            variants={shouldReduceMotion ? undefined : itemVariants}
          >
            {hero.subheadline}
          </motion.p>
          ...
          {/* CTAs */}
          <motion.div
            className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 mb-12 md:mb-16 px-4"
            variants={shouldReduceMotion ? undefined : itemVariants}
          >
            <Link
          ...
          {/* Trust Indicators */}
          <motion.div
            className="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-sm text-white/40"
            variants={shouldReduceMotion ? undefined : itemVariants}
          >
