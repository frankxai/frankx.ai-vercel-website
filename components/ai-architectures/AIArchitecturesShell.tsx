...
const architectures = [
  ...
  },
  {
    ...
    image: '/images/blog/generated/multi-agent-orchestration-patterns-2026-premium-hero.png',
    color: 'cyan',
...
export default function AIArchitecturesShell() {
  return (
    <>
...
export const architecturesCount = architectures.length
export const architecturesData = architectures
