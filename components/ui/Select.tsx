...
/**
 * Select Component
 * Dropdown select with glassmorphic styling
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={clsx(
      'flex h-11 w-full items-center justify-between rounded-lg px-4 py-3 text-sm transition-all duration-200',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={clsx('py-1.5 pl-8 pr-2 text-sm font-semibold text-white/50', className)}
    {...props}
  />
))
