 ...
 *   – this URL is unlisted and whether it is still a draft
 *   – the intended recipient role or the date it left Frank's hands
 *   – the current status in the proposal lifecycle
 *
 * Visual treatment: subdued emerald/cyan, sits above the hero so the recipient
 ...
 * cyan, closed-won = emerald, closed-archived = zinc/50).
 */
...
export function ProposalContext({
  ...
  return (
    <section
      ...
      className="border-b border-emerald-500/10 bg-emerald-500/[0.025]"
    >
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-sm">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-zinc-300">
            <span className="text-[10px] tracking-[0.25em] uppercase text-emerald-400/70 font-medium">
              Unlisted proposal
            </span>
            ...
            <span>
              {status === 'draft' ? 'Prepared for ' : 'Sent to '}
