      ...
      <div className="flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex-1 text-left">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-mono font-medium text-amber-400 bg-amber-400/10 px-2.5 py-0.5 rounded border border-amber-400/20">
              {magnet.badgeText || 'Executive Briefing'}
            </span>
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-white leading-snug mb-2 font-serif">
