...
const navigation = {
  ...
  learn: {
    ...
    items: [
      ...
      { name: 'Manifestation', href: '/manifestation', icon: Sparkles, description: 'Grounded manifestation + the Reality Architect loop',
      },
      { name: 'Reality Architect Quest', href: '/manifestation/quest', icon: Compass, description: '10-day practice, tracked in your browser',
      },
