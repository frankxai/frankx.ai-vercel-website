...
const navigation = {
  music: {
    ...
    featured: {
      ...
      description: 'Listen to the catalog, then follow the production notes and experiments behind it.',
      href: '/music',
      badge: 'Listening room',
    },
    items: [
      { name: 'Music Showcase', href: '/music', icon: Music, description: 'Selected releases and catalog pathways' },
      { name: 'Vibe OS', href: '/products/vibe-os', icon: Sparkles, description: 'Creative state and music-making system' },
      { name: 'Music Lab', href: '/music-lab', icon: Palette, description: 'Production workflows and studio experiments' },
      { name: 'Music School', href: '/music-school', icon: GraduationCap, description: 'Theory, prompting, production, and practice' },
  ...
  gencreators: {
    ...
    featured: {
      ...
      description: 'Build with generative tools without giving away your taste, voice, or judgment.',
      href: '/gencreator',
      badge: 'Framework',
    },
    items: [
      { name: 'GenCreator Hub', href: '/gencreator', icon: Flame, description: 'Framework, identity, practice, and pathways' },
      { name: 'Principles', href: '/gencreator/principles', icon: Compass, description: 'Human-led principles for generative work' },
      { name: 'Handbook', href: '/gencreator/handbook', icon: BookOpen, description: 'From identity and practice to a lasting body of work' },
      { name: 'Blueprints', href: '/gencreator/blueprints', icon: Map, description: 'Practical frameworks you can adapt' },
      { name: 'Prompt Library', href: '/prompt-library', icon: Sparkles, description: 'Prompts to inspect, adapt, and improve' },
  ...
  learn: {
    ...
    featured: {
      title: 'Learn Hub',
      description: 'Find your level, choose a useful outcome, and learn through guides, courses, books, and practice.',
      href: '/learn',
      badge: 'Hub',
    },
    items: [
      ...
      { name: "Frank's Books", href: '/books', icon: BookOpen, description: 'Published books, excerpts, and reading paths' },
      ...
      { name: 'AI Shorts', href: '/watch/shorts', icon: Zap, description: 'Short explanations for focused learning' },
    ],
  },
  build: {
    label: 'Build',
    ...
    featured: {
      ...
      description: 'Architecture decisions, blueprints, prototypes, and operating patterns for serious AI work.',
      href: '/ai-architecture',
      badge: 'Hub',
    },
    items: [
      { name: 'Architecture Hub', href: '/ai-architecture', icon: Network, description: 'Central hub for AI builders' },
      { name: 'Blueprints', href: '/ai-architecture/blueprints', icon: Layers, description: 'Architecture diagrams and implementation notes' },
      { name: 'Prototypes', href: '/ai-architecture/prototypes', icon: Terminal, description: 'Inspect and test working concepts' },
      { name: 'Templates', href: '/ai-architecture/templates', icon: Building, description: 'Starter structures with explicit availability' },
  ...
  explore: {
    ...
    featured: {
      ...
      description: 'Research, systems, creative worlds, partnerships, and the story connecting them.',
      href: '/resources',
      badge: 'Ecosystem',
    },
    items: [
