...
export default function InvestorHubShell() {
      ...
      <main className="relative min-h-screen">
        ...
        <section className="pb-8 pt-32 sm:pb-12 sm:pt-36">
          <div className="mx-auto max-w-6xl px-6">
            ...
            >
              <Image src="/images/mascot/axi-v4-hero.png" alt="Axi" width={48} height={48} className="rounded-xl" sizes="48px" style={{ boxShadow: '0 0 20px -6px rgba(6,182,212,0.3)' }} />
