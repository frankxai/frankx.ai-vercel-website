...
module.exports = {
  ...
  safelist: [
    // Text colors
    { pattern: /text-(rose|blue|emerald|purple|cyan|amber|violet|indigo|ana)-(300|400|500)/ },
    // Background colors
    { pattern: /bg-(rose|blue|emerald|purple|cyan|amber|violet|indigo|ana)-(400|500|500\/10)/ },
    // Border colors
    { pattern: /border-(rose|blue|emerald|purple|cyan|amber|violet|indigo|ana)-(400|500)/ },
  ],
  content: [
  ...
  theme: {
    extend: {
      colors: {
        ...
        // CONTEMPLATIVE INK - Editorial register (rails only)
        // Used on /on-god/, /on-reality/, /on-consciousness/, /on-faith/, /canon/
        // Same dark foundation as the rest of the site; warmer cream ink for slow reading
        'ink-contemplative': '#E8DDD0',
        'ink-contemplative-muted': '#C8B9A8',
        'ink-contemplative-faint': '#8A7B6B',
        ...
        ana: {
          ...
          cream:    '#F5EDD8',                  // Soft-light — text on dark
          obsidian: '#0E0E0F',                  // Grounding — page bg base
          glow:     'rgba(232, 169, 81, 0.15)', // Ambient amber glow
        },
      ...
      fontFamily: {
        ...
        // SOURCE SERIF 4 - Contemplative editorial register (only on /on-god/, /on-reality/, /on-consciousness/, /on-faith/, /canon/)
        'serif-editorial': ['var(--font-serif-editorial)', 'Source Serif 4', 'Georgia', 'serif'],
