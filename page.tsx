...
const aiArtworks: AIArtwork[] = [
  ...
  {
    id: '21',
    src: '/images/consciousness/alpha-wave-multiverse.png',
    title: 'Alpha Wave Multiverse',
    prompt: 'Visualization of brainwave patterns across multiple dimensions, alpha frequencies creating parallel realities, neural cosmos',
    model: 'nano-banana',
    category: 'Consciousness',
    tags: ['brainwaves', 'multiverse', 'neural'],
  },
  {
    id: '22',
    src: '/images/consciousness/quantum-bridge-framework.png',
    title: 'Quantum Bridge',
    prompt: 'Bridge between dimensions built from quantum particles, connection between mind and matter, consciousness architecture',
    model: 'nano-banana',
    category: 'Consciousness',
    tags: ['quantum', 'bridge', 'dimensions'],
  },
  {
    id: '23',
    src: '/images/consciousness/neuro-technical-blueprint.png',
    title: 'Neural Blueprint',
    prompt: 'Technical schematic of the human mind, neurons as circuit diagrams, consciousness engineering, mind architecture',
    model: 'nano-banana',
    category: 'Abstract',
    tags: ['neural', 'blueprint', 'technical'],
  },
  {
    id: '24',
    src: '/images/consciousness/quantum-neuroplasticity-guide.png',
    title: 'Neuroplasticity Map',
    prompt: 'Visual guide to brain rewiring, neural pathways forming and dissolving, quantum neuroplasticity in action',
    model: 'nano-banana',
    category: 'Consciousness',
    tags: ['neuroplasticity', 'brain', 'quantum'],
  },
  {
    id: '25',
  ...
  {
    id: '26',
    src: '/images/general/consciousness-triptych.png',
    title: 'Consciousness Triptych',
    prompt: 'Three states of consciousness visualized side by side, waking dreaming and transcendence, mind evolution',
    model: 'nano-banana',
    category: 'Consciousness',
    tags: ['triptych', 'states', 'evolution'],
  },
  {
    id: '27',
