...
<!-- STARLIGHT:BAND-B:BEGIN v1 sha=f6fcf460d4ff — generated by scripts/agents-md-project.mjs, do not hand-edit -->

## Company projection — FrankX.ai
...
| Company          | FrankX.ai — _operating_                                                  |
| Thesis           | Founder surface. Advisory, content, and the proof that the systems work. |
| Routes through   | Starlight Holding BV (holding — substrate and platform IP)               |
| Accountable seat | `agent:starlight-cmo`                                                    |
| Tier             | **T1 — revenue surface** · install: when working that company            |
| Deploys          | `surface:frankx.ai`                                                      |

**Brand register**

- **FrankX** — founder / AI Architect — results-first, understated. Pin: `starlight-design-intelligence/brand-packs/frankx/COPY.md`

**Tier rule.** Deploys to a live domain or holds a paying product.

**Escalation.** Decisions this repo cannot make alone go to `agent:starlight-cmo`.
