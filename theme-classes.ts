...
export interface ThemeClasses {
  ...
  // Gradient text
  gradientText: string;
  // Premium typography (v2 — Feb 2026)
...
const themeMap: Record<string, ThemeClasses> = {
  'love-and-poetry': {
    ...
    chapterNumberColor: 'text-rose-500/5',
    dropCapColor: 'text-rose-400',
  },
  'spartan-mindset': {
    ...
    chapterNumberColor: 'text-red-600/5',
    dropCapColor: 'text-red-500',
  },
  'golden-age': {
    ...
    chapterNumberColor: 'text-amber-500/5',
  ...
  'self-development': {
    ...
    chapterNumberColor: 'text-emerald-500/5',
  ...
  imagination: {
    ...
    chapterNumberColor: 'text-violet-500/5',
    dropCapColor: 'text-violet-400',
  },
  manifestation: {
    ...
    chapterNumberColor: 'text-amber-400/5',
    dropCapColor: 'text-amber-300',
  },
  ...
  'arcanea-lore': {
    ...
    chapterNumberColor: 'text-purple-600/5',
    dropCapColor: 'text-purple-400',
  },
  ...
  'arcanea-practice': {
    ...
    chapterNumberColor: 'text-indigo-600/5',
    dropCapColor: 'text-indigo-400',
  },
};
