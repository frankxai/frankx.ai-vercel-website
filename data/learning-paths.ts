  ...
  },
  {
    ...
    videos: [
      ...
      },
      {
        ...
        creator: youtubeChannels.aiExplained.name,
      ...
      {
        id: 'google-ai-studio-tutorial',
        youtubeId: 'bC6_00yq-Jg',
        title: 'Master Google AI Studio in 40 Minutes',
        creator: youtubeChannels.peterYang.name,
        creatorChannel: youtubeChannels.peterYang.url,
        duration: 'See YouTube',
        level: 'beginner',
        description:
          "Google developer relations lead Logan Kilpatrick joins Peter Yang to show how Google AI Studio has evolved into a complete vibe coding platform.",
        tags: ['ai-studio', 'prompting', 'builder'],
      },
      {
        id: 'google-ai-studio-databases',
        youtubeId: 'Zk-tP7r8WqI',
        title: 'Add Databases to Your App with AI Studio | Vibe Coding Guide',
        creator: youtubeChannels.googleDevelopers.name,
        creatorChannel: youtubeChannels.googleDevelopers.url,
        duration: 'See YouTube',
        level: 'intermediate',
        description:
          "Nikita Namjoshi shows how to build and provision full-stack backends with databases directly inside Google AI Studio's prototype environment.",
        tags: ['ai-studio', 'databases', 'full-stack'],
      },
      {
        id: 'google-ai-studio-prompts',
        youtubeId: 'jG39lT_4H4w',
        title: 'NEVER Write Wrong Prompts Again! Learn Prompt Engineering in Google AI Studio!',
        creator: youtubeChannels.deepLearningAI.name,
        creatorChannel: youtubeChannels.deepLearningAI.url,
        duration: 'See YouTube',
        level: 'beginner',
        description:
          "A practical tutorial covering system instructions, parameters, and variable inputs inside Google AI Studio.",
        tags: ['prompt-engineering', 'ai-studio', 'foundations'],
      },
      {
        ...
        level: 'beginner',
        description:
          "Paced, clear walkthrough showing how to install and setup Antigravity 2.0 and build your first local agent loop.",
        tags: ['antigravity', 'setup', 'beginner'],
      },
      {
        id: 'antigravity-cli-crash-course',
        youtubeId: 'F1W_vH-eZ0Q',
        title: 'Antigravity CLI Crash Course: Migrate from Gemini CLI',
        creator: youtubeChannels.codeWithAhsan.name,
        creatorChannel: youtubeChannels.codeWithAhsan.url,
        duration: 'See YouTube',
        level: 'intermediate',
        description:
          "How to transition from the deprecated Gemini CLI to the native Antigravity CLI (agy) for developer automation.",
        tags: ['antigravity', 'cli', 'migration'],
      },
      {
        id: 'antigravity-cli-tour',
        ...
        level: 'intermediate',
        description:
          "Deep-dive into the CLI primitives, planning modes, and the hooks coordination model built on the Antigravity agent harness.",
        tags: ['antigravity-cli', 'terminal', 'agents'],
      },
      {
        id: 'logan-model-eats-harness',
        youtubeId: 'uF98vSgC3Yk',
        title: 'Why the Model Eats the Harness: Logan Kilpatrick Interview',
        creator: youtubeChannels.sequoia.name,
        creatorChannel: youtubeChannels.sequoia.url,
        duration: 'See YouTube',
        level: 'intermediate',
        description:
          "Logan Kilpatrick sits down with Sequoia Capital to outline Google's long-term vision for developer agents and why scaffolding is shifting into the core models.",
        tags: ['discussion', 'future', 'developer'],
      },
      {
        id: 'notebooklm-2026',
      ...
      },
      {
        ...
        creator: youtubeChannels.mattWolfe.name,
        creatorChannel: youtubeChannels.mattWolfe.url,
        duration: 'See YouTube',
        level: 'intermediate',
        description:
          "Fifteen production-grade workflows for Nano Banana Pro (Gemini 3 Pro Image) covering text rendering, consistency, and prompt design.",
