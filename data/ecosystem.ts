...
export const ecosystemEntries: EcosystemEntry[] = [
  ...
  },
  {
    ...
    layer: 'L4-public-face',
    repo: 'frankx',
    publicUrl: 'https://frankx.ai/agents',
    repoUrl: null,
    status: 'live',
    shipped: '2026-04-23',
    summary: 'Canonical public registry of declared capabilities across the ACOS pillars.',
    description:
      'The source-computed index of every specialist agent, skill, command, and MCP capability in ACOS, including ship state, tier, and quality gates. Pairs with the hook-learning loop (CSV → learned.json → /hook bias) for measurable improvement over time.',
    relatedSystems: ['acos'],
