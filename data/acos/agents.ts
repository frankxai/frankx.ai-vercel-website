...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    specialists: [
      ...
      { name: 'Oracle Work', kind: 'skill', ref: 'oracle-work', status: 'in-progress', one_liner: 'Customer projects, presentations, demos, internal content.' },
      { name: 'Enterprise AI Architect', kind: 'skill', ref: 'oracle-ai-architect', status: 'in-progress', one_liner: 'Public enterprise AI architecture patterns and reference architectures.' },
  ...
  },
  {
    ...
    surface: '/familie',
    specialists: [
      { name: 'Familie Hub', kind: 'command', ref: '/familie', status: 'gap', one_liner: 'Public hub — not an agent. ADR-001 proposes rename to Family Heritage Curator.' },
      { name: 'Hoffnung Book', kind: 'command', ref: '/hoffnung', status: 'gap', one_liner: 'Public book route — not an agent. ADR-001 proposes rename to German Voice Keeper.' },
      { name: 'Atlas Globe', kind: 'command', ref: '/globe', status: 'gap', one_liner: 'Public route — not an agent. ADR-001 proposes rename to Trilingual Localizer.' },
      { name: 'Lebensbaum', kind: 'command', ref: '/lebensbaum', status: 'gap', one_liner: 'Public route — not an agent. ADR-001 proposes rename to Life-Tree Narrator.' },
      { name: 'Health & Nutrition Expert', kind: 'skill', ref: 'health-nutrition-expert', status: 'in-progress', one_liner: '2025 longevity, metabolic health, microbiome science.' },
      { name: 'Gym Training Expert', kind: 'skill', ref: 'gym-training-expert', status: 'in-progress', one_liner: 'Hypertrophy, progressive overload, biomechanics — 2025 research.' },
      { name: 'Greek Philosopher', kind: 'skill', ref: 'greek-philosopher', status: 'in-progress', one_liner: 'Socratic questioning, Stoic principles, philosophical inquiry.' },
      { name: 'Spartan Warrior', kind: 'skill', ref: 'spartan-warrior', status: 'in-progress', one_liner: 'Unbreakable discipline, courage, relentless excellence.' },
  ...
  },
  {
    ...
    surface: '/community',
    specialists: [
      { name: 'Vibeclubs Extension', kind: 'mcp', ref: 'vibeclubs', status: 'gap', one_liner: 'External product — not an agent. ADR-001 proposes rename to Vibeclub Host Coach.' },
      { name: 'GenCreator Lounge', kind: 'skill', ref: 'gencreator-lounge', status: 'gap', one_liner: 'Community product — not an agent. ADR-001 proposes rename to Lounge Curator.' },
      { name: 'Circle Membership', kind: 'skill', ref: 'gencreator-circle', status: 'gap', one_liner: 'Subscription tier — not an agent. ADR-001 proposes rename to Circle Conversion Strategist.' },
      { name: 'Studio Tier', kind: 'skill', ref: 'gencreator-studio', status: 'gap', one_liner: 'Subscription tier — not an agent. ADR-001 proposes rename to Studio Intake Advisor.' },
      { name: 'Social Media Strategy', kind: 'skill', ref: 'social-media-strategy', status: 'in-progress', one_liner: 'Platform-native content strategy with audience research.' },
      ...
      { name: 'Slack Gif Creator', kind: 'skill', ref: 'slack-gif-creator', status: 'in-progress', one_liner: 'Animated GIFs optimized for Slack.' },
      { name: 'Amplification Protocol', kind: 'command', ref: '/amplify-attendee', status: 'in-progress', one_liner: 'DUPLICATE with P5 — ADR-002 proposes rename to Member Journey Choreographer.' },
...
export const TIER_BY_REF: Record<string, AgentTier> = {
  ...
  // (4 category-errors omitted — no tier until ADR-001)
  'health-nutrition-expert': 'sonnet',
  'gym-training-expert': 'sonnet',
  'greek-philosopher': 'sonnet',
  'spartan-warrior': 'sonnet',
  'family-timeline': 'sonnet',
  // Pillar 10 — Community Fabric
  // (4 category-errors omitted — no tier until ADR-001)
  'social-media-strategy': 'sonnet',
  'social-content-generator': 'sonnet',
  'slack-gif-creator': 'haiku',
  '/amplify-attendee': 'haiku',
  'community-dashboard': 'haiku',
