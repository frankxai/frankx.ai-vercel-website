...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    specialists: [
      ...
      { name: 'Health & Nutrition Coach', kind: 'agent', ref: 'health-nutrition-coach', status: 'shipped', one_liner: 'Longevity and metabolic health specialist. Analyzes biomarkers, nutrition logs, recovery metrics, and longevity science.' },
