...
export const products: Product[] = [
  ...
  },
  {
    ...
    subtitle:
      'Production patterns for builders with a working agent. Checkout is not open while the release is verified.',
    hook: 'Release review in progress. No payment is collected.',
    pricing: { eur: 197, usd: 215, cadence: 'lifetime' },
    positioning:
      'For builders with a working agent and production gaps in evaluation, observability, cost, or deployment. The final offer will list only contents that are ready to deliver.',
    notFor: [],
    outcomes: [],
    includes: [],
    guarantee:
      'Checkout is not open. Refund terms will be published and verified before payment is accepted.',
    refundDays: 0,
    delivery: 'staged',
    decoupledFromFrank: true,
    frankTimePerBuyerPerQuarter: 'Not applicable while checkout is closed',
    color: 'cyan',
    funnelStage: 'mid',
    ctaText: 'Get the free Six Primitives Primer',
    featured: false,
  },
  {
  ...
  },
  {
    ...
    includes: [
      ...
      },
      {
        ...
        description: 'Frank\'s enterprise-grade trend distillation on the agent ecosystem — what shipped, what failed, what enterprises are deploying.',
        introducedAt: 'architect',
      },
      {
  ...
  },
  {
    ...
    outcomes: [
      ...
      'Apply Frank\'s enterprise AI CoE judgment to your specific decisions',
    ],
    includes: [
      {
      ...
      },
      {
        ...
        description: 'Real intros — not LinkedIn handoffs. Frank\'s professional network, AI partner network, and select FrankX customers.',
        introducedAt: 'founders',
      },
    ],
