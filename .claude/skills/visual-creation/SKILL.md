...
2. Use Claude/Gemini Flash to expand it with:
...
- **Council agent**: `.claude/agents/visual-creation-council.md`
...
- **Skill rules**: `.claude/skills/skill-rules.json` (triggers on image generation keywords)
