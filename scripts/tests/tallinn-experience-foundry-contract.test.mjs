...
test('workshop catalog separates delivered work from studio architectures', () => {
  ...
  assert.match(workshopsPage, /Ikigai &amp; Branding is the workshop Frank has personally developed and facilitated/)
  assert.match(workshopsPage, /Studio architecture/)
  assert.match(workshopsPage, /not presented as past delivery/)
