...
test("media-guard workflow still inspects pull_request heads and forbids pull_request_target", async () => {
  ...
  assert.match(request, /scripts\/media-guard\.mjs/u)
  assert.match(request, /persist-credentials: false/u)
