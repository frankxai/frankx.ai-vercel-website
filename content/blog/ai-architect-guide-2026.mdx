...
image: "/images/blog/six-plane-enterprise-ai-architecture.jpeg"
featured: true
...
**Q: Does an AI architect need to be a software engineer?**
...
**Q: Should an AI architect start with an agent framework?**
...
**Q: Which cloud or model provider is best for AI architecture?**
...
**Q: How do you measure whether an AI architecture works?**
...
**Q: What should be in an AI architect portfolio?**
...
This guide separates durable architecture guidance from dated product claims. The security, evaluation, observability, context, and protocol references point to primary documentation from OWASP, Google ADK, OpenAI, Anthropic, OpenTelemetry, and MCP. Vendor benchmarks are not used as proof of workflow quality. The [August edition](https://starlightintelligence.academy/guides/ai-architect-guide-2026-august-edition) is the dated source ledger, checked as of 27 August 2026.
