...
<FunnelCTA
  ...
  secondaryText="Open the public learning path"
/>
...
<FunnelCTA
  ...
  subhead="Use the public learning path to understand the system, then package the skills, commands, and activation rules in your own project."
  href="/start-here"
  ctaText="Open the public learning path"
