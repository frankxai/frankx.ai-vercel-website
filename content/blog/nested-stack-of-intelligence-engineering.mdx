...
Failure mode: no orchestration, just vibes. You have agents, you manually decide when to invoke each one, coordination lives in your head. That works for demos. It doesn't work when you're running 85 agents across four vendors and need consistent output.
