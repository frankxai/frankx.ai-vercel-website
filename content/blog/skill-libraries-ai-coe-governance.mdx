...
image: "/images/blog/native-premium/headers/skill-libraries-ai-coe-governance-hero.webp"
nativePremiumVisual:
  version: "2026-06-native-imagegen-premium-v1"
  hero: "/images/blog/native-premium/headers/skill-libraries-ai-coe-governance-hero.webp"
  sourceTool: "built-in image_gen"
  generationBatch: "019ef1f8-2819-77d1-b973-9a5a0b921c05"
  sourceCandidate: "11 skill governance cabinet"
...
This can start as a Markdown table. Here is one row, filled in, so the shape is concrete:

| Field | Example value |
| --- | --- |
| Skill name | `sales-proposal-builder` |
| Purpose | Draft a customer proposal from a deal brief using approved security language |
| Owner | Revenue Ops — J. Okafor |
| Version | 2.3.1 |
| Status | Approved |
| Risk tier | T2 |
| User group | Sales bundle |
| Tools | CRM read, pricing API (read-only) |
| Data class | Internal |
| Evaluations | `evals/sales-proposal/` — 7 scenarios, last pass 2026-06-10 |
| Last reviewed | 2026-06-10 |
| Rollback | 2.2.4 |

The standard matters more than the software. A row like this is the difference between a skill at maturity **L3** (it is evaluated) and one at **L4** (it is governed — owned, versioned, tiered, and reversible).
...
<Diagram src="/images/infographics/skill-risk-tiers.svg" alt="Risk tiers as a pyramid from T0 personal productivity to T4 operational action, with the review each tier requires" caption="Risk tiers — the controls scale with possible harm. T3 and above are where a skill must reach maturity L4 to ship." />

In the [Agent Skill Standard](https://github.com/frankxai/claude-skills-library/tree/main/standard), these tiers are not advisory. A skill above T2 cannot claim maturity level L4 until its registry row, evaluation suite, and rollback path exist.
