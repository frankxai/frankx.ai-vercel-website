...
<LeadMagnetCard id="acos-playbook" title="Download the Agentic Creator OS (ACOS) Playbook" subtitle="Get the complete zero-headcount architecture manual covering the 6-layer operating loop, audio/video atomization, and quality gates." />
