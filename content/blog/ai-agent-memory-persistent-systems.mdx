...
keywords: ["intelligence dispatches", "ai memory", "agent architecture", "claude code", "rag", "mcp"]
---
...
- [Memory as Exile: Why AI Systems Need Integration Loops](/blog/memory-as-exile-ai) — the architectural pattern for what your agent does with rejected drafts, blocked actions, and painful user signals. Most stacks skip this layer; it's the most underbuilt part of agent memory.
- [Self-Led AI Architecture](/research/self-led-ai-architecture) — internal governance pattern that makes long-term memory integrate cleanly instead of accumulating noise.
- [The Architecture of Intelligence](/research/series/architecture-of-intelligence) — the full research spine on agentic governance, predictive minds, and embodied cognition.
