...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    AI FACTORY INFRASTRUCTURE TOPOLOGY                       │
├─────────────────────────────────────────────────────────────────────────────┤
│  Power Substation & Grid Ingress (100MW+)                                   │
│       │                                                                     │
│       ▼                                                                     │
│  [Cooling Distribution Units (CDUs) · Direct-to-Chip Liquid Loops]          │
│       │                                                                     │
│       ├──► [NVIDIA GB200 NVL72 Racks] ──► NVLink 5 Fabric (1.8 TB/s)        │
│       │         │                              │                            │
│       │         ▼                              ▼                            │
│       │    [Massive Batch Inference]   [Frontier Pre-Training]              │
│       │                                                                     │
│       └──► [Groq LPU Inference Racks] ──► Deterministic SRAM Mesh (80 TB/s) │
│                 │                                                           │
│                 ▼                                                           │
│            [Real-Time Voice & Sub-15ms Agentic Loops]                       │
└─────────────────────────────────────────────────────────────────────────────┘
```
