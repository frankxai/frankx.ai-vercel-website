...
> **Gemini has moved on.** The current generation in routing is Gemini 3.5 Flash (default in Antigravity, beats 3.1 Pro on coding benchmarks at 4× speed) and Gemini 3.1 Pro with Deep Think mode. Cost/quality tradeoffs and the new "Antigravity vs Gemini CLI" decision are covered in our [Gemini & Google AI Mastery portal](/learn/gemini-mastery#faq).
...
_Built by Frank, former Oracle AI architect and creator of 12,000+ AI-generated songs. All analysis reflects personal experience building production multi-agent systems on OCI and public clouds._
