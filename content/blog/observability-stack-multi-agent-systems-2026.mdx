...
keywords: ["ai observability", "langsmith", "multi-agent monitoring", "ai agent tracing", "llm observability"]
image: "/images/blog/observability-stack.png"
---
...
│  - Latency      │  - Agent calls  │  - Errors      │ - RAGAS│
│  - Token usage  │  - Tool usage   │  - Decisions   │ - Custom│
│  - Costs        │  - Handoffs     │  - Context     │ - A/B  │
│  - Throughput   │  - Dependencies │  - User input  │        │
├─────────────────────────────────────────────────────────────┤
│                    COLLECTION LAYER                         │
│  OpenTelemetry │ Vendor SDKs │ Custom Instrumentation      │
└─────────────────────────────────────────────────────────────┘
```
...
|--------|-------------|-----------------|
| Cost per query | Average token cost | Over $0.10 |
| Daily spend | Total daily cost | Budget limit |
| Token waste | Unused context | Over 30% |
...
│
├── Using LangGraph, want seamless integration?
│   └── LangSmith
│
├── Complex multi-agent, ML team?
│   └── W&B Weave
│
├── Existing APM, want to integrate?
│   └── OpenTelemetry + existing stack
│
...
*Built with research from the [FrankX Research Intelligence](/research) layer. All statistics validated with multiple sources.*
