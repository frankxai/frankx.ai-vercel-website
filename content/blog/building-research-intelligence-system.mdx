...
description: "A technical analysis of the multi-agent research system powering FrankX.AI - five specialized agents, three workflow modes, and a publication pipeline optimized for the AI age."
date: "2026-01-21"
author: "Frank"
...
### Mode 2: Full Analysis (`/research [topic]`)
...
<Diagram
  ...
  alt="Mode 2: Full Analysis (/research topic) diagram 1"
  caption="Mode 2: Full Analysis (/research topic)"
/>
