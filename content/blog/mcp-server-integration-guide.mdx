...
keywords: ["model context protocol", "mcp server", "claude mcp integration", "mcp tutorial", "claude code tools", "ai api integration"]
...
│                         CLAUDE CODE                              │
│                                                                  │
│  User: "Take a screenshot of frankx.ai"                         │
│                              │                                   │
│                              ▼                                   │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │              TOOL SELECTION LAYER                        │   │
│  │  Detects: screenshot request → needs Browser MCP         │   │
│  └─────────────────────────────────────────────────────────┘   │
│                              │                                   │
└──────────────────────────────┼───────────────────────────────────┘
                               │
...
│                                                                  │
│  1. Receives: browser_navigate("https://frankx.ai")             │
│  2. Executes: Playwright launches browser                        │
│  3. Receives: browser_take_screenshot()                          │
...
│                         CLAUDE CODE                              │
│                                                                  │
│  Receives image, displays to user                                │
│  "Here's the screenshot of frankx.ai"                           │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
...
*[MCP Specification](https://modelcontextprotocol.io/) | [GitHub](https://github.com/frankxai/agentic-creator-os) | [FrankX](https://frankx.ai)*
