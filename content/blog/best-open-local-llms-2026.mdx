...
Compiled June 5, 2026 from vendor model cards and independent sources (Artificial Analysis, llm-stats, LMArena, NIST/CAISI). Verified vs vendor-claimed figures are distinguished in each linked model analysis.*
