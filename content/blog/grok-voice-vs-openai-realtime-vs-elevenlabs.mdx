...
*By FrankX — AI architect and independent builder. Architecture receipts: [voice-provider ADR](https://github.com/frankxai/Starlight-Intelligence-System/blob/main/docs/specs/2026-08-24-voice-provider-architecture-decision.md) and [runtime provider options](https://github.com/frankxai/starlight-voice/blob/main/docs/PROVIDER-OPTIONS.md).*
