...
tldr: "Anthropic released Claude Fable 5 on June 9, 2026 — a Mythos-class model made safe for general availability, while the unrestricted Claude Mythos 5 stays gated behind trusted-access programs. Launch numbers lead agentic coding: 95.0% SWE-bench Verified and ~80% SWE-bench Pro."
