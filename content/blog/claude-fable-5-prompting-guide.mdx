...
tldr: "Every Fable 5 prompting guide published this week is extrapolating from the model card. This one is derived from behavior we measured: four head-to-head eval rounds against Opus 4.8 inside Claude Code, with published JSON receipts. The seven rules: stack constraints freely."
