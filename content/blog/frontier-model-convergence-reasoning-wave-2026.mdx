...
```mermaid
graph LR
    A[User Intent / Task] --> B{Complexity Classifier}
    B -->|System 1: High Velocity| C[Autoregressive Flash Model]
    B -->|System 2: Formal Logic| D[Inference-Time Search Engine]
    D --> E[MCTS / Best-of-N Sampling]
    E --> F[Process Reward Model PRM]
    F -->|Verified Pass| G[Deterministic Output]
    F -->|Logic Fail| E
    C --> G
>>>>>>> origin/main
```
