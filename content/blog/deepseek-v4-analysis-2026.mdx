...
tldr: "DeepSeek released V4 on April 24, 2026 — two models, both MIT-licensed with open weights on Hugging Face. V4-Pro is a 1.6T-parameter MoE with ~49B active; V4-Flash is 284B total / ~13B active. Both ship a 1M-token context window. V4-Pro posts 80.6% on SWE-bench Verified —."
