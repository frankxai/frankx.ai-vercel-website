...
architectNote:
  recommendation: "Opus 4.6 is superseded — Opus 4.7 and 4.8 followed at the same $5/$25, and Fable 5 (June 9, 2026) now holds the agentic-coding ceiling — so don't start new work on this model ID. Its lasting contribution to your AI Center of Excellence is structural: the 67% price cut, 1M context, and adaptive thinking it introduced are what made routing complex tasks to Opus-tier economical, and they carried forward unchanged. If you're still pinned to claude-opus-4-6, the upgrade path is a string swap plus the 4.7 breaking changes (budget_tokens, sampling params, prefills) documented in the 4.8 analysis."
  ...
  personas:
    ...
    - persona: "Long-context repo agents"
      pick: "Opus 4.8 (same 1M ctx, same price, better model)"
