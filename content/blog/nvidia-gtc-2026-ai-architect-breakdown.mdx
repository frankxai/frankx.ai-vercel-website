...
tldr: "NVIDIA GTC 2026 unveiled Vera Rubin — seven chips, five rack types, 3.6 exaflops, 700 million tokens per second. The Groq LPU acquisition splits prefill and decode for 35x tokens-per-watt improvement. Dynamo 1.0 is the inference OS. NemoClaw provides the agentic execution."
