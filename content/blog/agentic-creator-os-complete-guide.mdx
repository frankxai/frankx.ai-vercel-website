...
description: "The AI operating system that turns Claude Code into a full creative studio. 25 commands, 80+ skills, swarm intelligence, and auto-activation. The definitive guide."
date: "2026-01-27"
...
Agentic Creator OS (ACOS) turns Claude Code from a chat tool into a full operating system for creators. Version 6 introduces a smart router (`/acos`), auto-activating skills, and a hooks system for quality enforcement. You get 25 commands, 80+ skills, 40+ agents, and 8 orchestrated workflows—all without writing code. Install in 5 minutes. Start with `/acos`. [Free on GitHub](https://github.com/frankxai/agentic-creator-os).

---

## What Is Agentic Creator OS?

Agentic Creator OS is an **operating system for generative creators** -- a persistent intelligence layer on top of Claude Code that changes how you work with AI daily.
