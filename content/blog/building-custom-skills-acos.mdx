...
<Diagram
  src="/images/diagrams/blog/building-custom-skills-acos/skill-directory-structure.svg"
  alt="Recommended ACOS skill directory structure with SKILL.md and resources"
  caption="Recommended skill layout: concise core instructions with deep references in resources."
/>
...
<Diagram
  src="/images/diagrams/blog/building-custom-skills-acos/project-skill-placement.svg"
  alt="Project-level skill placement inside .claude/skills directory"
  caption="Project-scoped installation path for sharing a skill with collaborators."
/>
