...
keywords: ["claude code skills", "acos custom skills", "skill-rules.json", "ai skill development", "claude code tutorial"]
...
Skills teach Claude *what to know*.
Agents tell Claude *how to behave*.
Commands are *how users invoke things*.
  ...
  "rules": [
    {
      ...
      "triggers": {
        "keywords": ["api docs", "api documentation", "document api", "endpoint", "swagger", "openapi"],
...
*[Skill Template](https://github.com/frankxai/agentic-creator-os/blob/main/templates/SKILL_TEMPLATE.md) | [GitHub](https://github.com/frankxai/agentic-creator-os) | [FrankX](https://frankx.ai)*
