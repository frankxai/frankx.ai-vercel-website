...
tldr: "— After discovering that 82% of images on frankx.ai were orphaned, flagship posts relied on placeholder SVGs, and three blog articles shared an identical hero image, I built a 6-layer Visual Intelligence System (VIS) to bring order to the chaos. The site's visual health score."
