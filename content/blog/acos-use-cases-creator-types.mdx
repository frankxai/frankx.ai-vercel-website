...
author: "Frank"
tags: ["agentic ai", "creator workflows", "use cases", "productivity", "tutorial"]
keywords: ["ai for content creators", "ai for writers", "ai for musicians", "ai for developers", "ai workflow by profession", "acos use cases"]
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│   IDEATE    │───►│  RESEARCH   │───►│   DRAFT     │───►│   PUBLISH   │
│             │    │             │    │             │    │             │
│ /plan-week  │    │ /research   │    │ /article-   │    │ /publish    │
│             │    │             │    │  creator    │    │             │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│   SPEC      │───►│   DESIGN    │───►│   BUILD     │───►│   SHIP      │
│             │    │             │    │             │    │             │
│ /spec       │    │ /ux-design  │    │ (coding)    │    │ /nextjs-    │
│             │    │             │    │             │    │  deploy     │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│   CONCEPT   │───►│  GENERATE   │───►│   REFINE    │───►│  DISTRIBUTE │
│             │    │             │    │             │    │             │
│ Idea/mood   │    │ /create-    │    │ Iterate     │    │ /generate-  │
│ description │    │  music      │    │ prompts     │    │  social     │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│  RESEARCH   │───►│  STRATEGIZE │───►│   DECIDE    │───►│   EXECUTE   │
│             │    │             │    │             │    │             │
│ /research   │    │ /starlight- │    │ /council    │    │ /plan-week  │
│             │    │  architect  │    │             │    │             │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
# ACOS will:
# 1. Convene Luminor Oracle (strategy), Creation Engine (product),
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│  OUTLINE    │───►│   CREATE    │───►│   PACKAGE   │───►│   LAUNCH    │
│             │    │             │    │             │    │             │
│ Curriculum  │    │ /products-  │    │ Platform    │    │ /generate-  │
│ design      │    │  creation   │    │ setup       │    │  social     │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
...
```
┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
│  ONBOARD    │───►│   SCOPE     │───►│   DELIVER   │───►│   REVIEW    │
│             │    │             │    │             │    │             │
│ Client      │    │ /spec       │    │ (execution) │    │ /review-    │
│ discovery   │    │             │    │             │    │  content    │
└─────────────┘    └─────────────┘    └─────────────┘    └─────────────┘
```
