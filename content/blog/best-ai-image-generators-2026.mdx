...
tldr: "— In mid-2026 the measured leader is GPT Image 2 (OpenAI) — the first reasoning-based image model, topping every blind-vote arena by a record margin on prompt adherence and photorealism. Google's Nano Banana 2 (Gemini 3.1 Flash Image) is the best value — frontier-adjacent."
