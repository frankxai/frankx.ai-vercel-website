...
tldr: "On December 2, 2025, Mistral shipped Mistral Large 3 (mistral-large-2512) — a sparse Mixture-of-Experts model with 675B total / 41B active parameters, released under Apache 2.0. Base and instruct weights are on Hugging Face; there is no commercial-license catch on this one."
