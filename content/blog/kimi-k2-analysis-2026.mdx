...
tldr: "Moonshot AI's current flagship is Kimi K2.6 (kimi-k2.6), released April 20, 2026 under a Modified MIT license with open weights on Hugging Face. It's a 1-trillion-parameter Mixture-of-Experts model that activates only 32B parameters per token, ships with a 256K."
