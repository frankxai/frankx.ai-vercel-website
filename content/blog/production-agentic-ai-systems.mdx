...
The problem isn't the code. It's the composition. You're trying to score a film before you've written the main theme. What follows isn't about the syntax of agents -- it's about the **rhythm of production**. When to let the agents improvise, when to force them to follow the sheet music, and how to build a stage that doesn't collapse under the weight of the performance.
...
Most teams over-engineer because they try to go straight to the symphony without learning to play the instrument first. Here's the progression.
...
When the mic feeds back, it ruins the show. These patterns stop the screeching before it starts.
