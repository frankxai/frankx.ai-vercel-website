...
architectNote:
  recommendation: "Use the lowest intervention that crosses the required quality, latency, economics, and governance threshold. Begin with representative evals; add context, retrieval, tools, skills, and a modular harness; run a time-boxed PEFT experiment when a stable behavioral gap remains; move into continued or scratch pretraining only when the representation or model itself is the strategic product."
  coePillar: "Strategy · model ownership + Technology · evaluation and deployment + Governance · data, license, and sovereignty"
  personas:
    - persona: "Solo or early-stage founder"
      pick: "One primary managed model, portable evals, a thin harness, and one tested contingency"
    - persona: "Startup with proprietary examples"
      pick: "Baseline first, then a time-boxed LoRA or QLoRA specialist experiment"
    - persona: "High-volume product"
      pick: "Quality-adjusted API versus dedicated-inference crossover test"
    - persona: "Regulated enterprise"
      pick: "Governed data plane, open interfaces and evals, controlled specialist models"
---
