...
- Score >= 70: Recommend Deep Dive <!-- ai-slop-allow -->
...
```
Sourced → Screened → First Look → Deep Dive → IC Review → Term Sheet → Closed <!-- ai-slop-allow -->
```

Each stage transition requires:

- **Screened → First Look**: Score >= 50, human confirms
- **First Look → Deep Dive**: Score >= 65, DD Lead initiates <!-- ai-slop-allow -->
- **Deep Dive → IC Review**: DD report complete, score >= 70 <!-- ai-slop-allow -->
