...
featured: false
readingGoal: "You'll learn actionable architectural frameworks, core implementation steps, and production strategies for building automated deal flow pipelines with ai and n8n."
...
- Score >= 70: Recommend technical analysis {/* ai-slop-allow */}
...
- **First Look → technical analysis**: Score >= 65, DD Lead initiates {/* ai-slop-allow */}
- **technical analysis → IC Review**: DD report complete, score >= 70 {/* ai-slop-allow */}
