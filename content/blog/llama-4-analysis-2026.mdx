...
tldr: "As of June 2026, Meta's flagship open-weight model is still Llama 4 Maverick (meta-llama/Llama-4-Maverick-17B-128E-Instruct) — a 400B-total / 17B-active mixture-of-experts model with a 1M-token context window, native text-and-image input, and a 16K max output, released April."
