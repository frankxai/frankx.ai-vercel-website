...
For a complete commission with reusable prompts and acceptance checks, use the [reference-to-campaign workflow](/guides/reference-to-campaign). The [Images 2.5 analysis](/blog/chatgpt-images-2-5-creator-founder-workflows) explains the September 2026 release and links its planned arena evaluation.
