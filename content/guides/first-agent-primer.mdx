...
At this point, verify the agent against the acceptance checklist. The [workshop's six branches](/workshops/build-first-ai-agent) describe possible next areas:
...
CORS. Configure the required origin policy explicitly for `/.well-known/agent.json`; do not assume a template has done it for you.
