...
- Enforce the **Santa Loop** (Generation Subagent $\leftrightarrow$ Adversarial Reviewer Subagent).
...
$$\text{CPVO} = \frac{\text{Hourly Hardware Cost} \times \text{Latency}}{\text{First-Pass Pass Rate}}$$
