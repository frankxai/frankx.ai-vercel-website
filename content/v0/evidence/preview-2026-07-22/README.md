...
Captured from the READY Vercel preview for draft PR 351 on 2026-07-22.

- Branch alias: `https://frankx-ai-vercel-website-git-code-112517-starlight-intelligence.vercel.app`
- Viewports: 1440x900 and 390x844
- Routes: `/v0`, `/v0/templates/visual-foundry`, and `/v0/studio`
- Workflow states: initial, review, desktop complete, and mobile complete
