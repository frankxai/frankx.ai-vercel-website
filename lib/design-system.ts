...
export const colors = {
  ...
  accent: {
    ...
    ana: {
      ...
      cream:    '#F5EDD8',                  // Soft-light — text on dark, chibi bg
      obsidian: '#0E0E0F',                  // Grounding — jaguar coat, page bg base
      glow:     'rgba(232, 169, 81, 0.15)', // Ambient amber glow (vs Frank's electric-cyan)
    },
  },
