...
export const planInitiatives: PlanInitiative[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: 'ps-1', title: 'Create data registry with types and seed data', status: 'active', assignedAgent: 'FORGE' },
      { id: 'ps-2', title: 'Build hub page with track tabs and filters', status: 'pending', assignedAgent: 'FORGE' },
      { id: 'ps-3', title: 'Build detail pages with tasks and milestones', status: 'pending', assignedAgent: 'FORGE' },
      { id: 'ps-4', title: 'Integrate with /feed via VECTOR agent', status: 'pending', assignedAgent: 'GRID' },
      { id: 'ps-5', title: 'Create /plan-update command', status: 'pending', assignedAgent: 'CIPHER' },
      { id: 'ps-6', title: 'Deploy to production', status: 'pending', assignedAgent: 'GRID' },
    ],
    milestones: [
      { title: 'Data registry + types', targetDate: '2026-02-07', status: 'upcoming' },
      { title: 'Hub + detail pages live', targetDate: '2026-02-08', status: 'upcoming' },
    ],
    agentComments: [
