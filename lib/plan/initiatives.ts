...
export const planInitiatives: PlanInitiative[] = [
  ...
  },
  {
    ...
    description: 'A public showcase where different AI coding agents and skills are tested against the same design briefs. Each experiment pits tools like Claude Code + ui-ux-pro-max, v0.dev, and Cursor head-to-head. Outputs are rated on design, code quality, accessibility, performance, and creativity. Winning designs get productized and offered for sale. Transparent, educational, and a unique content angle no competitor has.',
    tldr: 'AI agents compete at design challenges. Side-by-side comparisons with ratings. Winners become purchasable products. Live at frankx.ai/design-lab.',
    icon: 'FlaskConical',
    color: 'teal',
    track: 'creative',
    status: 'shipped',
