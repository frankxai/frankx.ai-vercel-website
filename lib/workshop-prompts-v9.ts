...
- No generic self-help hero-copy filler.
- No fake drama.
- No empty AI hype.
...
Then choose the ONE post I should publish FIRST today, and explain why. State the day-7 metric that will tell me the plan is working.`,
  ...
  // ─── 5a ─ One LinkedIn Post (paired with three-versions in module 5)
  {
    ...
    subtitle:
      'Hook → problem → tension → insight → shift → close. Under 180 words. Human, useful, no corporate jargon, no fake vulnerability, no "game-changer", no generic self-help hero-copy filler.',
    body: `${OPERATING_RULE_SHORT}
