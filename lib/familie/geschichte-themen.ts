...
export const geschichteThemen: GeschichteThema[] = [
  ...
  // ── Riemer-Linie ───────────────────────────────────────────────────────────
  {
    ...
    schlüsselfakten: [
      { label: 'Gesicherte Generationen', wert: '5 (Christian → Frank)' },
      { label: 'Älteste Überlieferung', wert: 'Christian Riemer, 1914' },
      { label: 'Herkunfts-Hypothesen', wert: '3 Wolga-Kolonien' },
      { label: 'Offene Fragen', wert: '12' },
    ],
    abschnitte: [
      {
        nummer: '01',
        titel: 'Was wir wissen: Christian Riemer (1914)',
        status: 'überlieferung',
        inhalt: [
          'Der älteste namentlich überlieferte Vorfahre unserer direkten Linie ist Christian Riemer, geboren 1914 in Karaganda, Kasachstan. Seine Existenz und sein Geburtsjahr stammen aus der Familienüberlieferung — über Opa Alexander und Papa Witali an Frank weitergegeben.',
          'Was wir von Christian verlässlich wissen, ist bemerkenswert wenig: Dass er existierte. Dass er 1914 geboren wurde. Dass er wolgadeutscher Abstammung war. Dass er die Trudarmee überlebte. Alles Weitere — seine Eltern, sein Geburtsdorf, seine Heimatkolonie — liegt jenseits des Familiengedächtnisses.',
        ],
      },
      {
        nummer: '02',
        titel: 'Was wir vermuten: Herkunfts-Hypothesen',
        status: 'hypothese',
        inhalt: [
          'Der Familienname Riemer (auch Reimer) ist in mehreren wolgadeutschen Kolonien dokumentiert. Das erlaubt uns, Hypothesen zu bilden — aber nicht mehr als das. Keine dieser Spuren ist bewiesen für unsere Familie.',
          'Die wahrscheinlichsten Herkunftsorte sind drei Kolonien, in denen Reimer/Riemer-Familien historisch belegt sind: Reinwald (gegründet 1766, Gründungssiedler Johann Konrad Reimer aus Freudental), Katharinenstadt (eine der größten Kolonien), und Orlovsky (eine Siedlung, in der die Schreibweise "Riemer" gebräuchlicher war).',
          'Ob Christian aus einer dieser drei Kolonien stammte — oder aus einer Tochterkolonie, einer anderen Region, oder gar aus nicht-wolgadeutschem Kontext — bleibt offen. Das ist die zentrale unbeantwortete Frage der Riemer-Linie.',
        ],
        details: [
          { titel: 'Hypothese Reinwald', text: 'Gründungssiedler Johann Konrad Reimer (geb. 1729, Freudental). 1798 Census: Konrad + Katharina Steinbrecher + 5 Kinder. Nachfolgende Census-Dokumentation fehlt aktuell.', status: 'hypothese' },
          { titel: 'Hypothese Katharinenstadt', text: 'Eine der Gründungskolonien der Wolgadeutschen. Riemer-Familien dokumentiert, Umfang unbekannt. Schreibweise variabel.', status: 'hypothese' },
          { titel: 'Hypothese Orlovsky', text: 'Siedlung mit historisch dominanter "Riemer"-Schreibweise (statt Reimer). Forum-Hinweise in wolgadeutsche.net.', status: 'hypothese' },
        ],
      },
      {
        nummer: '03',
        titel: 'Was wir nicht wissen',
        status: 'unbekannt',
        inhalt: [
          'Die 116 Jahre zwischen dem letzten archivisch belegten Reimer-Eintrag (Reinwald Census 1798) und Christian Riemers Geburt (Karaganda 1914) sind für unsere Linie vollständig dunkel. Wir kennen weder seine Eltern noch seine Geschwister, weder seine Herkunfts-Kolonie noch die Umstände seiner Ankunft in Karaganda.',
          'Wir wissen auch nicht, ob die Familie die 1941er-Deportation betraf (plausibel aber unbelegt), wann sie nach Karaganda kam (vor 1914 offensichtlich, aber wie viele Generationen davor?), und ob es Geschwister, Cousins oder andere überlebende Linien gibt.',
        ],
      },
      {
        nummer: '04',
        titel: 'Wie Sicherheit möglich wäre',
        status: 'verifiziert',
        inhalt: [
          'Die Riemer-Linie verifiziert zu schließen, erfordert drei parallele Arbeitsstränge. Jeder hat konkrete Aktionen und konkrete Archive, die angefragt werden müssen.',
        ],
        details: [
          { titel: 'Oral History (höchste Priorität)', text: 'Interviews mit Opa Alexander: Wer waren Christians Eltern? Aus welchem Dorf kam er? Wann kam die Familie nach Karaganda? Existieren Fotos, Dokumente, Briefe?' },
          { titel: 'GAKO Karaganda', text: 'Anfrage an das Staatsarchiv Karaganda (de.archiv.kz2022@gmail.com) nach Christians Sondersiedler-Akte. Diese Akten enthalten oft Eltern-Namen, Herkunftsort, Transportdaten.' },
          { titel: 'FamilySearch Kirchenbücher', text: 'Samara Church Books 1748-1934. Suche nach Reimer/Riemer-Einträgen mit Verbindung zu Karaganda oder umliegenden Gebieten nach 1880.' },
        ],
      },
      {
        nummer: '05',
        titel: 'Die gesicherten jüngeren Generationen',
        status: 'überlieferung',
        inhalt: [
          'Ab Alexander Riemer (Opa) ist die Linie durch direkte Familienkenntnis belegt: Alexander (Sohn von Christian) → Witali (Sohn von Alexander und Paulina geb. Schneider) → Frank (Sohn von Witali und Dora geb. Gorte). Diese Generationen stehen auf festem Boden.',
          'Die Herausforderung liegt vor Alexander. Christian ist die Schwelle — jenseits dieser Schwelle beginnt die Hypothesen-Arbeit.',
        ],
      },
    ],
    zeitstrahl: [
      { jahr: '1914', titel: 'Christian Riemer geboren', text: 'In Karaganda, Kasachstan (Familienüberlieferung)', ort: 'Karaganda', typ: 'familie', status: 'überlieferung' },
      { jahr: '1941–46', titel: 'Trudarmee', text: 'Christian überlebt die Zwangsarbeit (Familienüberlieferung)', typ: 'krieg', status: 'überlieferung' },
      { jahr: 'Ca. 1940–50', titel: 'Alexander Riemer geboren', text: 'Sohn von Christian — Geburtsjahr und -ort zu erfragen', typ: 'familie', status: 'unbekannt' },
      { jahr: 'Ab 1990', titel: 'Aussiedlung nach Deutschland', text: 'Spätaussiedlung der Familie', typ: 'migration', status: 'überlieferung' },
      { jahr: 'Heute', titel: 'Frank Riemer in Amsterdam', text: 'Direkte Linie über Witali, Alexander, Christian', ort: 'Amsterdam', typ: 'familie', status: 'verifiziert' },
    ],
    faq: [
      {
        frage: 'Warum steht nirgends „Wir stammen aus Reinwald"?',
        antwort: 'Weil wir es nicht wissen. Reinwald ist eine von mehreren Hypothesen. Der Gründungssiedler Johann Konrad Reimer (1729, Freudental) ist archivisch belegt — aber ob unsere Familie von ihm abstammt, ist nicht bewiesen. Genauso wahrscheinlich ist Katharinenstadt oder Orlovsky. Wir behaupten nichts, was wir nicht zeigen können.',
      },
      {
        frage: 'Was ist die 116-Jahre-Lücke?',
        antwort: 'Zwischen dem letzten dokumentierten Reimer-Census in Reinwald (1798) und Christian Riemers Geburt in Karaganda (1914) liegen 116 Jahre. In dieser Zeit gab es Umsiedlungen, Tochterkolonien, Deportationen. Für unsere direkte Linie haben wir keinen archivischen Beleg in dieser Zeit — das ist ehrlich, auch wenn es unbefriedigend ist.',
      },
      {
        frage: 'Ist Riemer und Reimer der gleiche Name?',
        antwort: 'Ja. Beide sind Schreibvarianten desselben Familiennamens, vom mittelhochdeutschen „riemaere" (Riemenmacher). In den Kolonie-Registern kommen beide Schreibweisen vor — oft für dieselbe Familie.',
      },
      {
        frage: 'Was ist die wichtigste offene Frage?',
        antwort: 'Wer waren Christians Eltern, und wann kam die Familie nach Karaganda? Opa Alexander lebt noch — er ist die direkteste Quelle, die wir haben. Jedes Interview mit ihm ist wertvoller als jede Archivrecherche.',
      },
    ],
    quellen: [
      { name: 'wolgadeutsche.net — Forum Reimer/Riemer', url: 'http://forum.wolgadeutsche.net', typ: 'website' },
      { name: 'Volga German Institute — Surnames', url: 'https://volgagermaninstitute.org', typ: 'website' },
      { name: 'FamilySearch Samara Church Books 1748–1934', url: 'https://www.familysearch.org', typ: 'archiv' },
      { name: 'Staatsarchiv Karaganda (GAKO) — Sondersiedler-Akten', url: 'https://de-archiv.kz', typ: 'archiv' },
      { name: 'AHSGR Deportations-Transportakten', url: 'https://ahsgr.org/research/', typ: 'archiv' },
    ],
    familienverbindung: 'Die Riemer-Linie ist unsere väterliche Abstammung. Gesichert von Frank zurück bis Christian Riemer (1914). Davor: offen. Die Arbeit der kommenden Jahre ist, die Zeit vor Christian zu rekonstruieren — durch Gespräche mit Opa Alexander und Anfragen an das Staatsarchiv Karaganda.',
    familienverbindungStatus: 'überlieferung',
  ...
  // ── Gorte-Linie ────────────────────────────────────────────────────────────
  {
    ...
    untertitel: 'Mütterlicherseits — eine Linie mit mehr Fragen als Antworten',
    kurzfassung: 'Die Gorte-Linie ist Franks mütterliche Abstammung: Mama Dora, eine von zehn Kindern von Opa David Gorte und Oma Dorothea (geb. Prager). Vor Opa David und Oma Dorothea wird es schnell dunkel — zwei unbekannte Ursprünge warten darauf, erforscht zu werden.',
    farbe: 'amber',
    icon: 'Heart',
    öffentlich: false,
    gesamtstatus: 'überlieferung',
    schlüsselfakten: [
      { label: 'Gesicherte Generationen', wert: '3 (Frank → David)' },
      { label: 'Davids Kinder', wert: '10 (Namen teilweise offen)' },
      { label: 'Bekannte Vorfahren', wert: '0 vor Gen. 0' },
      { label: 'Offene Fragen', wert: '15+' },
    ],
    abschnitte: [
      {
        nummer: '01',
        titel: 'Die gesicherte Gegenwart: Dora, David, Dorothea',
        status: 'überlieferung',
        inhalt: [
          'Die Gorte-Linie ist von Frank zurück bis zu seinen Großeltern mütterlicherseits gesichert: Mama Dora (geb. Gorte) ist die Tochter von Opa David Gorte und Oma Dorothea Gorte (geb. Prager). Beide Großeltern leben — das ist eine Tatsache, die sich täglich ändern kann. Jedes Gespräch, jede Aufnahme zählt.',
          'Dora war eines von zehn Kindern. Durch ihre Ehe mit Witali Riemer verbindet sie die Gorte- mit der Riemer-Linie. Sie ist buchstäblich die Brücke zwischen zwei Familien, die ohne sie nicht zueinander gefunden hätten.',
        ],
      },
      {
        nummer: '02',
        titel: 'Die erste Schwelle: Davids zehn Kinder',
        status: 'überlieferung',
        inhalt: [
          'Opa David hat zehn Kinder großgezogen — eine große Familie, typisch für wolgadeutsche Haushalte. Wir kennen Dora. Die anderen neun Geschwister sind teilweise im Familiengedächtnis, teilweise nicht. Die Namen vollständig zu sammeln, ist Aufgabe Nummer eins der Gorte-Forschung.',
          'Diese Geschwister sind wertvoll, weil sie lebende Zeugen derselben Ursprungsfamilie sind. Jeder von ihnen hat möglicherweise andere Puzzlestücke — andere Fotos, andere Geschichten von den Eltern, andere Erinnerungen an Davids eigene Eltern.',
        ],
      },
      {
        nummer: '03',
        titel: 'Die zweite Schwelle: Davids Eltern (unbekannt)',
        status: 'unbekannt',
        inhalt: [
          'Wir wissen nicht, wer Davids Eltern waren. Weder Namen noch Geburtsorte noch Lebensdaten. Dies ist keine Nebenrolle — es ist die zentrale Unbekannte der gesamten Gorte-Linie. Ohne diese Information können wir die Gorte-Herkunft nicht einmal ansatzweise rekonstruieren.',
          'Die direkteste Lösung: Opa David fragen, solange er das erzählen kann. Alles andere — Archive, DNA-Tests, Forum-Recherche — ist sekundär, bis wir den Namen seines Vaters und seiner Mutter haben.',
        ],
      },
      {
        nummer: '04',
        titel: 'Die dritte Schwelle: Dorothea Prager, geborene Prager',
        status: 'unbekannt',
        inhalt: [
          'Dorothea Gorte trägt den Geburtsnamen Prager. Vor der Ehe mit David war sie Dorothea Prager — Tochter unbekannter Eltern, aus einem unbekannten Ort. Der Name Prager ist bedeutsam: er ist nicht selten, aber auch nicht überall, und er könnte Hinweise auf eine Prag-Verbindung (Böhmen) oder eine sudetendeutsche Linie geben — oder etwas ganz anderes.',
          'Auch hier: die einzige belastbare Quelle ist Oma Dorothea selbst. Zweitbeste Quelle wären ihre Geschwister oder Cousins, wenn es Kontakte gibt.',
        ],
      },
      {
        nummer: '05',
        ...
        status: 'verifiziert',
        inhalt: [
          'Die Gorte-Linie hat keine vermeintlichen Archivfunde, die wir relativieren müssten — sie hat stattdessen einen klaren Fahrplan zu tatsächlichen Entdeckungen.',
        ],
        details: [
          { titel: 'Interview Opa David (höchste Priorität)', text: 'Namen der zehn Kinder. Namen der Eltern Davids. Geburtsort. Heimatdorf der Familie. Beruf der Eltern. Bilder, Dokumente, Briefe? Alles, bevor das Gedächtnis es verliert.' },
          { titel: 'Interview Oma Dorothea (gleiche Priorität)', text: 'Namen ihrer Eltern (Prager-Seite). Geburtsort. Geschwister. Woher kam der Name Prager? Gibt es Dokumente oder mündliche Überlieferung über die Prager-Linie?' },
          { titel: 'Kontakt zu Dora-Geschwistern', text: 'Wenn Dora-Geschwister erreichbar sind: Jeder könnte ein anderes Fragment der Elternerzählung kennen. Zehn Quellen sind besser als eine.' },
        ],
      },
    ],
    zeitstrahl: [],
    faq: [
      {
        frage: 'Warum ist die Gorte-Seite so viel kürzer als die Riemer-Seite?',
        antwort: 'Weil wir weniger wissen — und das sichtbar zu machen ist wichtiger, als Lücken mit Spekulation zu füllen. Die Gorte-Linie hat vor Generation 0 (David und Dorothea) keine bekannten Vorfahren. Das ist ehrlich.',
      },
      {
        frage: 'Warum stehen die zehn Kinder nicht hier?',
        antwort: 'Weil wir ihre Namen noch nicht vollständig haben. Das Sammeln dieser Namen ist eine der wichtigsten nächsten Aufgaben — sie sind lebende Zeugen derselben Ursprungsfamilie.',
      },
      {
        frage: 'Hat der Name Prager eine Bedeutung?',
        antwort: 'Möglicherweise. Prager könnte auf eine Prag-Verbindung (Böhmen) hindeuten, oder auf sudetendeutsche Herkunft, oder auf etwas Drittes. Ohne weitere Information von Oma Dorothea ist jede Deutung Spekulation.',
      },
    ],
    quellen: [
      { name: 'Direkte Familienerinnerung (Opa David, Oma Dorothea, Mama Dora)', typ: 'dokument' },
    ],
    familienverbindung: 'Die Gorte-Linie ist unsere mütterliche Abstammung. Gesichert bis zu den noch lebenden Großeltern. Davor: zwei unbekannte Ursprünge — Davids Eltern und Dorotheas Eltern. Die nächste Forschungsarbeit ist keine Archivsuche, sondern ein Besuch.',
    familienverbindungStatus: 'überlieferung',
