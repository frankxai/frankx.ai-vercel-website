...
export const domainSources: Record<string, ResearchSource[]> = {
  ...
  'housing-crisis-decisions': [
    ...
    { name: 'Victoria Transport Policy', title: 'Parking Cost, Pricing and Revenue — Transportation Cost Analysis', url: 'https://www.vtpi.org/tca/tca0504.pdf', type: 'industry-report' },
