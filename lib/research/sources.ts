...
export const domainSources: Record<string, ResearchSource[]> = {
  'ai-model-strategy': [
    ...
    { name: 'OpenAI', title: 'Fine-Tuning Learning Guide', url: 'https://developers.openai.com/learn/fine-tuning', type: 'official' },
    { name: 'OpenAI', title: 'Introducing gpt-oss', url: 'https://openai.com/index/introducing-gpt-oss/', date: '2025-08-05', type: 'official' },
    { name: 'OpenAI', title: 'gpt-oss Model Card', url: 'https://openai.com/index/gpt-oss-model-card/', date: '2025-08-05', type: 'official' },
    { name: 'OpenAI', title: 'Fine-Tune gpt-oss with Transformers', url: 'https://developers.openai.com/cookbook/articles/gpt-oss/fine-tune-transfomers', type: 'official' },
    { name: 'Anthropic', title: 'Building Effective Agents', url: 'https://www.anthropic.com/engineering/building-effective-agents', date: '2024-12-19', type: 'official' },
    { name: 'Anthropic', title: 'Introducing Contextual Retrieval', url: 'https://www.anthropic.com/engineering/contextual-retrieval', date: '2024-09-19', type: 'official' },
    ...
    { name: 'Anthropic', title: 'Equipping Agents with Agent Skills', url: 'https://www.anthropic.com/engineering/equipping-agents-for-the-real-world-with-agent-skills', date: '2025-10-16', type: 'official' },
    { name: 'Anthropic', title: 'Harness Design for Long-Running Application Development', url: 'https://www.anthropic.com/engineering/harness-design-long-running-apps', date: '2026-03-24', type: 'official' },
    { name: 'Anthropic', title: 'Writing Tools for Agents', url: 'https://www.anthropic.com/engineering/writing-tools-for-agents', date: '2025-09-11', type: 'official' },
    { name: 'Anthropic', title: 'Demystifying Evals for AI Agents', url: 'https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents', date: '2026-01-09', type: 'official' },
    { name: 'Anthropic', title: 'Claude Platform Glossary: Fine-Tuning', url: 'https://platform.claude.com/docs/en/about-claude/glossary', type: 'official' },
    { name: 'Google', title: 'Gemma 4', url: 'https://blog.google/innovation-and-ai/technology/developers-tools/gemma-4/', date: '2026-04-02', type: 'official' },
    { name: 'Google AI for Developers', title: 'Fine-Tuning with the Gemini API', url: 'https://ai.google.dev/gemini-api/docs/model-tuning', type: 'official' },
    { name: 'Google Cloud', title: 'Gemini Enterprise Supervised Tuning', url: 'https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/tuning/supervised-tuning', type: 'official' },
    { name: 'Google AI for Developers', title: 'Fine-Tune Gemma with QLoRA', url: 'https://ai.google.dev/gemma/docs/core/huggingface_text_finetune_qlora', type: 'official' },
    { name: 'Meta AI', title: 'The Llama 4 Herd', url: 'https://ai.meta.com/blog/llama-4-multimodal-intelligence/', date: '2025-04-05', type: 'official' },
    ...
    { name: 'NVIDIA', title: 'The Future of AI Is Open and Proprietary', url: 'https://blogs.nvidia.com/blog/ai-future-open-and-proprietary/', date: '2026-03-25', type: 'official' },
    { name: 'NVIDIA', title: 'Nemotron Coalition', url: 'https://nvidianews.nvidia.com/news/nvidia-launches-nemotron-coalition-of-leading-global-ai-labs-to-advance-open-frontier-models', date: '2026-03-16', type: 'official' },
    { name: 'NVIDIA Research', title: 'Nemotron 3 Ultra Technical Report', url: 'https://research.nvidia.com/labs/nemotron/files/NVIDIA-Nemotron-3-Ultra-Technical-Report.pdf', date: '2026-06-09', type: 'official' },
    { name: 'NVIDIA Developer', title: 'Inside NVIDIA Nemotron 3', url: 'https://developer.nvidia.com/blog/inside-nvidia-nemotron-3-techniques-tools-and-data-that-make-it-efficient-and-accurate/', date: '2025-12-15', type: 'official' },
    { name: 'NVIDIA Research', title: 'Nemotron-Cascade 2', url: 'https://research.nvidia.com/labs/nemotron/nemotron-cascade-2/', date: '2026-03-16', type: 'official' },
    { name: 'NVIDIA', title: 'Enterprise Software Leaders Build AI Agents with NVIDIA', url: 'https://investor.nvidia.com/news/press-release-details/2026/Enterprise-Software-Leaders-Build-AI-Agents-With-NVIDIA/default.aspx', date: '2026-06-01', type: 'official' },
    { name: 'NVIDIA Developer', title: 'Nemotron 3 Ultra Harness Profile', url: 'https://developer.nvidia.com/blog/create-a-langchain-deep-agents-harness-profile-for-nvidia-nemotron-3-ultra-to-improve-performance/', date: '2026-07-08', type: 'official' },
    { name: 'NVIDIA NeMo', title: 'Parameter-Efficient Fine-Tuning', url: 'https://docs.nvidia.com/nemo-framework/user-guide/25.07/automodel/peft.html', type: 'official' },
    { name: 'Nous Research', title: 'Nous Research Releases', url: 'https://nousresearch.com/releases', type: 'official' },
    { name: 'Nous Research', title: 'Hermes Agent Documentation', url: 'https://hermes-agent.nousresearch.com/docs/', type: 'official' },
    { name: 'Hugging Face', title: 'Training Models with Hugging Face Skills', url: 'https://huggingface.co/blog/hf-skills-training', date: '2025-12-04', type: 'official' },
    { name: 'Hugging Face', title: 'Hugging Face Skills Documentation', url: 'https://huggingface.co/docs/hub/en/agents-skills', type: 'official' },
    { name: 'Hugging Face', title: 'TRL PEFT Integration', url: 'https://huggingface.co/docs/trl/peft_integration', type: 'official' },
    { name: 'Hugging Face', title: 'Inference Providers', url: 'https://huggingface.co/docs/inference-providers/index', type: 'official' },
    { name: 'Hugging Face', title: 'Inference Endpoints Pricing', url: 'https://huggingface.co/docs/inference-endpoints/pricing', type: 'official' },
    { name: 'AWS', title: 'Amazon Bedrock Pricing', url: 'https://aws.amazon.com/bedrock/pricing/', type: 'official' },
    { name: 'AWS', title: 'Bedrock Custom Model Import', url: 'https://docs.aws.amazon.com/bedrock/latest/userguide/model-customization-import-model.html', type: 'official' },
    { name: 'AWS', title: 'Bedrock Data Retention', url: 'https://docs.aws.amazon.com/bedrock/latest/userguide/data-retention.html', type: 'official' },
    { name: 'AWS', title: 'SageMaker Deployment Options', url: 'https://docs.aws.amazon.com/sagemaker/latest/dg/deploy-model-options.html', type: 'official' },
    { name: 'Microsoft', title: 'Managed Compute in Microsoft Foundry', url: 'https://learn.microsoft.com/en-us/azure/foundry/concepts/managed-compute-overview', type: 'official' },
    { name: 'Microsoft', title: 'Microsoft Foundry Data, Privacy, and Security', url: 'https://learn.microsoft.com/en-us/azure/foundry/responsible-ai/openai/data-privacy', type: 'official' },
    { name: 'Microsoft', title: 'Fine-Tuning Considerations', url: 'https://learn.microsoft.com/en-us/azure/foundry/openai/concepts/fine-tuning-considerations', date: '2026-03-11', type: 'official' },
    { name: 'Google Cloud', title: 'Generative AI Pricing', url: 'https://cloud.google.com/gemini-enterprise-agent-platform/generative-ai/pricing', type: 'official' },
    { name: 'Google Cloud', title: 'Generative AI Data Residency', url: 'https://docs.cloud.google.com/gemini-enterprise-agent-platform/resources/data-residency', date: '2026-07-29', type: 'official' },
    { name: 'Oracle Cloud Infrastructure', title: 'Dedicated AI Cluster Billing', url: 'https://docs.oracle.com/en-us/iaas/Content/generative-ai/pay-dedicated.htm', type: 'official' },
    { name: 'Oracle Cloud Infrastructure', title: 'Compatible Models for Import', url: 'https://docs.oracle.com/en-us/iaas/Content/generative-ai/imported-models.htm', date: '2026-07-16', type: 'official' },
    { name: 'Oracle Cloud Infrastructure', title: 'Generative AI Data Handling', url: 'https://docs.oracle.com/en-us/iaas/Content/generative-ai/data-handling.htm', type: 'official' },
    { name: 'NVIDIA', title: 'NVIDIA NIM FAQ', url: 'https://docs.api.nvidia.com/nim/docs/product', type: 'official' },
    { name: 'Fireworks AI', title: 'Fireworks Pricing', url: 'https://fireworks.ai/pricing', type: 'official' },
    { name: 'Fireworks AI', title: 'Choose Fine-Tuning Infrastructure', url: 'https://docs.fireworks.ai/fine-tuning/training-api/choose-infrastructure', type: 'official' },
    { name: 'Fireworks AI', title: 'Deploying LoRA Models', url: 'https://docs.fireworks.ai/fine-tuning/deploying-loras', type: 'official' },
    { name: 'Replicate', title: 'Replicate Pricing', url: 'https://replicate.com/pricing', type: 'official' },
    { name: 'Replicate', title: 'Replicate Billing', url: 'https://replicate.com/docs/topics/billing', type: 'official' },
    { name: 'Replicate', title: 'Deploy a Custom Model', url: 'https://replicate.com/docs/get-started/deploy-a-custom-model', type: 'official' },
    { name: 'European Union', title: 'Consolidated EU Artificial Intelligence Act', url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX%3A02024R1689-20260727', date: '2026-07-27', type: 'official' },
    { name: 'European Commission', title: 'Commission Starts Enforcing AI Act Rules and New Transparency Requirements', url: 'https://digital-strategy.ec.europa.eu/en/news/commission-starts-enforcing-ai-act-rules-and-new-transparency-requirements-2-august', date: '2026-08', type: 'official' },
    { name: 'European Commission', title: 'Guidelines on Obligations for General-Purpose AI Providers', url: 'https://digital-strategy.ec.europa.eu/en/faqs/guidelines-obligations-general-purpose-ai-providers', type: 'official' },
    { name: 'European Union', title: 'General Data Protection Regulation', url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX%3A02016R0679-20160504', type: 'official' },
    { name: 'European Data Protection Board', title: 'Opinion 28/2024 on Certain Data Protection Aspects Related to the Processing of Personal Data in the Context of AI Models', url: 'https://www.edpb.europa.eu/system/files/2024-12/edpb_opinion_202428_ai-models_en.pdf', date: '2024-12', type: 'official' },
    { name: 'European Union', title: 'Trade Secrets Directive', url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=CELEX%3A32016L0943', date: '2016', type: 'official' },
    { name: 'European Union', title: 'European Health Data Space Regulation', url: 'https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX%3A32025R0327', date: '2025', type: 'official' },
    { name: 'European Commission', title: 'Medical Device and AI Act FAQ', url: 'https://health.ec.europa.eu/document/download/b78a17d7-e3cd-4943-851d-e02a2f22bbb4_en', type: 'official' },
    { name: 'European Medicines Agency', title: 'Reflection Paper on the Use of Artificial Intelligence in the Medicinal Product Lifecycle', url: 'https://www.ema.europa.eu/system/files/documents/scientific-guideline/reflection-paper-use-artificial-intelligence-ai-medicinal-product-lifecycle-en.pdf', type: 'official' },
    { name: 'European Union', title: 'EU Data Act', url: 'https://eur-lex.europa.eu/eli/reg/2023/2854/oj/eng', type: 'official' },
    { name: 'UNECE', title: 'UN Regulation No. 155: Cyber Security and Cyber Security Management System', url: 'https://unece.org/transport/documents/2021/03/standards/un-regulation-no-155-cyber-security-and-cyber-security', type: 'official' },
    { name: 'UNECE', title: 'UN Regulation No. 156: Software Update and Software Update Management System', url: 'https://unece.org/transport/documents/2021/03/standards/un-regulation-no-156-software-update-and-software-update', type: 'official' },
    { name: 'Federal Ministry of Justice, Germany', title: 'Federal Data Protection Act', url: 'https://www.gesetze-im-internet.de/englisch_bdsg/englisch_bdsg.html', type: 'official' },
    { name: 'CCMO Netherlands', title: 'Research Data, Coding, and Privacy', url: 'https://english.ccmo.nl/investigators/legal-framework-for-medical-scientific-research/wmo-in-a-nutshell/research-data-coding-and-privacy', type: 'official' },
    { name: 'CCMO Netherlands', title: 'Research with Participants Under the Age of 16', url: 'https://english.ccmo.nl/investigators/additional-requirements-for-certain-types-of-research/research-with-participants-under-the-age-of-16-years-children', type: 'official' },
  ],
