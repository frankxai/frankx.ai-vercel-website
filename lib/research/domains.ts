...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'US — Stargate Project', description: 'Announced large-scale, multi-year OpenAI infrastructure program involving SoftBank, OpenAI, Oracle, and MGX. Public reporting describes multi-site US capacity plans; verify current figures before republishing exact commitments.', badge: 'Announced' },
        ],
      },
      {
    ...
    faq: [
      ...
      { question: 'How much have governments committed to sovereign AI by 2026?', answer: 'Aggregating tracked commitments — US Stargate as an announced large-scale multi-year infrastructure program, UAE Stargate ($30B+), Saudi HUMAIN ($600B opportunity per Wedbush/NVIDIA), France 2030 (€109B), EU InvestAI Gigafactories (€20B), UK AI Growth Zones ($38.5B private), Japan ($135B), India IndiaAI Mission (~$1.25B) — total cumulative pledges exceed $1.5T through EOY 2026. Most of this is announced, not yet deployed; CNAS tracks 130+ active government-led sovereign AI projects as of January 2026. Verify current public sources before republishing exact program-level figures.' },
      ...
      { question: 'What are Stargate UAE and the original US Stargate?', answer: 'Two different projects sharing branding. The original Stargate Project was announced in January 2025 as a large US infrastructure buildout for OpenAI involving SoftBank, OpenAI, Oracle, and MGX; exact current commitment and capacity figures should be verified against public sources before republication. Stargate UAE was announced in May 2025 as a $30B / 5GW Abu Dhabi campus by G42 + OpenAI + Oracle + NVIDIA + Cisco + SoftBank, with the first 200MW phase going live in Q3 2026.' },
