...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    relatedDomains: ['prompt-engineering', 'mcp-ecosystem', 'multi-agent-systems', 'ai-agent-config', 'production-patterns', 'agentic-life-architecture', 'agentic-memory'],
...

  {
    ...
    relatedDomains: ['context-engineering', 'agentic-memory', 'multi-agent-systems', 'agent-frameworks', 'production-patterns', 'mcp-ecosystem', 'ai-ops', 'self-led-ai-architecture', 'meaning-os', 'enterprise-ai'],
...

  {
    ...
    relatedDomains: ['agentic-life-architecture', 'context-engineering', 'vector-databases', 'multi-agent-systems', 'production-patterns', 'mcp-ecosystem', 'ai-security', 'ai-ops', 'prompt-engineering'],
