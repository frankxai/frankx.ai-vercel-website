...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      { stat: '8', label: 'Frontier models tracked', source: 'Industry Analysis' },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'For Agent Systems', description: 'Three-tier routing: Haiku (fast/cheap) → Sonnet (balanced) → Opus (complex). Cost-optimized with adaptive thinking.', badge: 'Agents' },
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    description: 'How to configure AI coding agents for production: CLAUDE.md as project constitution, skill activation systems, hook-based lifecycle automation, agent specialization, and multi-agent orchestration patterns. Covers patterns emerging across the Claude Code, Cursor, and Windsurf ecosystems.',
    tldr: 'AI agent configuration has evolved from simple system prompts to multi-layered architectures. CLAUDE.md acts as a project constitution, skills provide hot-reloadable capabilities, hooks automate lifecycle events, and agent profiles define specialized roles. Production teams scale to hundreds of skills without chaos through lazy loading, context-aware activation, and explicit handoff protocols.',
    icon: 'Cpu',
    color: 'orange',
    category: 'models-tools',
    highlights: [
      { stat: '500+', label: 'Skills available globally', source: 'Claude Code Skills Registry' },
      { stat: '40+', label: 'Specialized agent profiles', source: 'Community Patterns' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { title: 'Commands (Workflow)', description: 'Slash-command playbooks that encode complete workflows: prerequisites, decision matrices, step-by-step processes, and quality gates.', badge: 'Layer 4' },
        ],
      },
      {
      ...
      },
      {
        ...
        content: 'Production agent systems solve the "too many skills" problem through lazy loading, priority ordering, and exclusion patterns. Limiting concurrent skill loads to 5 prevents context bloat. Skills are priority-ranked (critical > high > medium > low). Exclude patterns filter irrelevant skills (e.g., exclude Shopify skills in a non-commerce project). The result: hundreds of skills available, but only the relevant 3-5 are active at any time.',
      },
      {
    ...
    faq: [
      ...
      { question: 'How do skills activate in production agent systems?', answer: 'Skills activate through three trigger dimensions: keyword matching, intent pattern regex matching, and file glob pattern matching.' },
      { question: 'How many skills can run concurrently?', answer: 'Production systems typically limit concurrent skills to 3-5 via lazy loading and priority ordering, keeping hundreds of skills available but only the relevant ones active at any time.' },
    ],
    keyFindings: [
      ...
      'Gamification of skill progression — mapping technical capabilities to narrative milestones — improves developer engagement',
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { question: 'How do investors configure AI agents for research?', answer: 'Investors configure AI coding agents with investment-specific skills, agent profiles, MCP servers, and visual intelligence capabilities. Purpose-built configurations turn general-purpose AI into dedicated investment research platforms with persistent memory, source validation, and automated reporting.' },
    ...
    relatedBlogPosts: ['/blog/ai-agents-transform-due-diligence', '/blog/building-deal-flow-pipelines-ai'],
  ...
  },
  {
    ...
    highlights: [
      ...
      { stat: '30-50%', label: 'QA cycle reduction with AI', source: 'Elsner Technologies' },
    ],
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'React Three Fiber', description: 'Declarative React components for Three.js (core: 2.7M weekly npm downloads). WebGPU support since r171. Best for 3D games and immersive experiences.', badge: 'Mature' },
          { title: 'Pure React + Web Audio', description: 'Zero-dependency approach for quiz games, word games, puzzle games, card games. Production-proven for interactive audio instruments.', badge: 'Simplest' },
      ...
      },
      {
        ...
        content: 'The AI game development toolchain has matured into production-ready categories. Asset generation (Scenario, Leonardo AI), world building (Promethean AI — trusted by major studios including PlayStation Studios), NPC intelligence (Inworld AI, Charisma AI), and music composition (AIVA for adaptive soundtracks) each compress weeks of specialized work into hours.',
        items: [
      ...
      },
      {
        ...
        items: [
          { title: 'Free-to-Play + Ads', description: 'Rewarded ads with high completion rates. Players opt in to watch for benefits. Google AdMob integration.', badge: 'Volume' },
          ...
          { title: 'Subscription/Battle Pass', description: 'Seasonal content unlocks drive retention and recurring revenue. Rewards engagement over payment.', badge: 'Retention' },
        ],
      },
      {
      ...
      {
        title: 'What AI Coding Agents Can Build Right Now',
        content: 'AI coding agents like Claude Code, Cursor, and Windsurf can generate complete browser games using skills and tool integrations. Combined with MCP servers for image generation, browser testing, and deployment, the agentic pipeline from concept to production is functional today for single-player browser games.',
        items: [
          { title: 'Game Dev Skills', description: 'Phaser integration, Three.js, React patterns, Web Audio, UI design, testing — available as installable skill packs for AI agents.', badge: 'Available' },
          { title: 'Tool Integrations', description: 'AI image generation (Gemini, DALL-E), browser testing (Playwright), deployment (Vercel), backend (Supabase) — full pipeline.', badge: 'Production' },
          { title: 'Agent Specialization', description: 'Dedicated agent profiles for UI design, deployment, narrative writing, and audio production improve output quality.', badge: 'Pattern' },
          { title: 'Current Limitations', description: 'No real-time multiplayer server generation. No physics engine integration (yet). No GPU-intensive 3D. Best for 2D and casual 3D.', badge: 'Honest' },
        ],
      },
    ],
    keyFindings: [
    ...
    faq: [
      ...
      { question: 'What AI tools generate game assets?', answer: 'Scenario (game-specific sprites, tileable textures, consistent characters), Leonardo AI (concept art, UI elements), AIVA (adaptive music composition), ElevenLabs (AI voice acting), Inworld AI (intelligent NPC behavior and dialogue). Each tool is production-ready in 2026.' },
      ...
      { question: 'How do you monetize browser games without app stores?', answer: 'Direct payment via Stripe or Lemon Squeezy (no 30% store fee), rewarded ads via Google AdMob (high completion rates, players opt in), battle passes and subscriptions for recurring revenue, and game template sales on itch.io, Gumroad, or direct ($27-97 per template).' },
      { question: 'Can AI coding agents build a complete game?', answer: 'AI coding agents can generate complete single-player browser games using Phaser or React Three Fiber. Combined with MCP servers for image generation, browser testing, and deployment, the pipeline from concept to production works today. Limitations: no real-time multiplayer server generation, no GPU-intensive 3D.' },
