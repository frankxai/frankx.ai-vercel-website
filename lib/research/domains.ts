...
export const researchDomains: ResearchDomain[] = [
  {
    ...
    description:
      'A primary-source research hub for founders and enterprise teams deciding when to use an API, add retrieval and agent skills, fine-tune an existing model, self-host open weights, or train new model capability. The framework connects differentiation, lawful data rights, evaluations, infrastructure economics, sovereignty, and EU governance.',
    tldr:
      'The strategic question is not whether to own a model. It is which layer of intelligence is worth owning. Start by owning lawful data, representative evaluations, critical interfaces, workflow logic, and feedback. Rent frontier capability while it is interchangeable; move toward retrieval, skills, routing, fine-tuning, self-hosting, or new training only when verified outcomes, differentiation, latency, privacy, sovereignty, availability, or quality-adjusted economics justify the added control. FrankX publishes the evidence and decision method; Starlight packages reusable substrate and implementation products teams can deploy themselves.',
    icon: 'Scale',
    color: 'emerald',
    ...
    sections: [
      {
        ...
        content: 'Model ownership is only one possible control point. For most teams, the durable asset is the governed learning loop: lawful domain data, evaluation cases that represent real work, workflow and tool contracts, routing policy, feedback, and distribution. Those layers compound across model releases and preserve optionality when a provider, price, license, or benchmark changes.',
        items: [
          { title: 'Own lawful data', description: 'Confirm rights, provenance, permitted purpose, quality, labels, and deletion obligations before treating data as an advantage.', badge: 'Asset' },
          ...
          { title: 'Own interfaces', description: 'Keep tool schemas, workflow state, memory contracts, and policy boundaries portable across models and providers.', badge: 'Substrate' },
          { title: 'Own feedback', description: 'Turn observed failures and verified outcomes into new eval cases, retrieval updates, skills, or training examples.', badge: 'Compounding' },
        ],
      },
      {
        title: 'The Lowest-Intervention Ladder',
        content: 'Use the lowest intervention that crosses the required outcome, latency, economics, and governance thresholds. The layers can stack; they are not mutually exclusive. Moving upward adds control, but also evaluation scope, operational load, and lifecycle responsibility.',
        items: [
          { title: 'Prompt and context', description: 'Clarify instructions, examples, schemas, and context selection before changing weights.', badge: 'Layer 1' },
          { title: 'Retrieval and tools', description: 'Bring current or private knowledge into the system and connect deterministic capabilities.', badge: 'Layer 2' },
          { title: 'Skills, routing, and harnesses', description: 'Encode reusable workflows and route each task to an appropriate model, tool, or verifier.', badge: 'Layer 3' },
          { title: 'Fine-tune or adapt', description: 'Change repeated behavior or modality performance with PEFT, supervised tuning, distillation, continued pretraining, or modality-specific adaptation.', badge: 'Layer 4+' },
          { title: 'Self-host or train', description: 'Take responsibility for serving open weights or creating new capability only when the control surface is strategically necessary.', badge: 'Layer 6–7' },
        ],
      },
      {
        title: 'How to Choose the Intervention',
        content: 'The decision starts with the failure, not the fashionable technique. Retrieval teaches the system what it needs to know now. Skills and harnesses teach repeatable execution without changing weights. Fine-tuning changes repeated behavior. Continued pretraining can adapt representation to a domain. New training is justified only when the required capability cannot be reached reliably through lower layers.',
        items: [
          { title: 'Knowledge gap', description: 'Use retrieval, long context, or tools when facts are private, current, attributable, or frequently changing.', badge: 'Retrieve' },
          { title: 'Workflow gap', description: 'Use skills, structured tools, routing, memory, and evaluator loops when failures occur in execution.', badge: 'Harness' },
          { title: 'Behavior gap', description: 'Use fine-tuning when a stable, repeated behavior remains below the eval threshold after context and workflow design.', badge: 'Adapt' },
          { title: 'Capability gap', description: 'Consider continued pretraining, distillation, modality adaptation, or training only with sufficient data, capital, evaluation, and operations.', badge: 'Train' },
        ],
      },
      {
        title: 'Platform Choice Is a Lifecycle Choice',
        content: 'AWS, Microsoft, Google Cloud, Oracle Cloud, NVIDIA, Fireworks, Replicate, and Hugging Face expose different combinations of managed inference, tuning, imported models, dedicated compute, customer-environment deployment, portability, residency, retention, and billing. Compare the full lifecycle and contract, not a single token price or benchmark.',
        items: [
          { title: 'Managed model APIs', description: 'Optimize for capability access, release velocity, regional availability, retention terms, and switching cost.', badge: 'Rent' },
          { title: 'Managed open-model platforms', description: 'Compare training path, artifact export, serving topology, minimum commitments, observability, and portability.', badge: 'Adapt' },
          { title: 'Dedicated and sovereign compute', description: 'Model utilization, idle capacity, accelerator supply, patching, and staffing determine whether control creates value.', badge: 'Operate' },
          { title: 'Quality-adjusted economics', description: 'Include inference, retrieval, retries, evaluation, human review, engineering, compliance, and downtime in cost per verified success.', badge: 'Measure' },
        ],
      },
      {
        title: 'Open and Proprietary Are Portfolio Choices',
        content: 'Open weights can improve inspectability, deployment control, adaptation, and ecosystem participation. Proprietary frontier models can provide capability and operational leverage that would be uneconomic to recreate. A strong architecture can orchestrate both while keeping the learning loop portable. Open weights do not automatically mean open source, low cost, safe, or compliant.',
        items: [
          { title: 'Check the license', description: 'Review model, code, data, output, acceptable-use, geographic, and redistribution terms separately.', badge: 'Rights' },
          { title: 'Check the recipe', description: 'Weights alone may omit training data, preprocessing, post-training, evaluation, and safety artifacts.', badge: 'Transparency' },
          { title: 'Check total operations', description: 'Serving, optimization, monitoring, security, red-teaming, updates, and incident response remain adopter responsibilities.', badge: 'Burden' },
          { title: 'Preserve escape paths', description: 'Use portable interfaces, exportable artifacts, and provider-independent evals to keep future model choices reversible.', badge: 'Optionality' },
        ],
      },
      {
        title: 'EU and Regulated-Sector Decision Gates',
        content: 'In the EU, model strategy must be evaluated in the context of role, intended purpose, data category, deployment, and downstream use. The AI Act, GDPR, trade-secret rules, health-data regulation, medical-device guidance, the Data Act, and automotive cybersecurity and update regimes can all change the viable architecture. Legal summaries here are educational and require fact-specific professional review.',
        items: [
          { title: 'Role and intended purpose', description: 'Determine whether the organization is a provider, deployer, modifier, importer, distributor, or operator and how the system will be used.', badge: 'Scope' },
          { title: 'Data rights and safeguards', description: 'Map legal bases, special-category conditions, purpose limits, DPIA needs, transfers, retention, access, and re-identification risk.', badge: 'Data' },
          { title: 'Lifecycle evidence', description: 'Preserve provenance, evaluation, change control, cybersecurity, human oversight, and post-deployment monitoring artifacts.', badge: 'Governance' },
          { title: 'Confidential cases', description: 'Do not publish client details, rare cohorts, data combinations, or proprietary recommendations without written clearance and re-identification review.', badge: 'Boundary' },
        ],
      },
      {
        title: 'Self-Serve Implementation Through Starlight',
        content: 'FrankX makes the research and method legible. Starlight turns the method into reusable substrate and products: evaluation contracts, model-decision schemas, routing patterns, governed skills, and model-operations components. Teams use those artifacts to implement the approach inside their own architecture through an educational, self-serve path.',
        items: [
          { title: 'Decision schema', description: 'Record the target outcome, eval threshold, data rights, capital envelope, control requirements, and reversibility plan.', badge: 'Product' },
          { title: 'Evaluation contract', description: 'Define representative tasks, success criteria, trajectory gates, latency, cost, and review burden before platform selection.', badge: 'Substrate' },
          { title: 'Portable model operations', description: 'Separate interfaces, routing, receipts, and policy from any single provider or checkpoint.', badge: 'Pattern' },
          { title: 'Implementation by the team', description: 'Adopt the artifacts inside existing product, security, data, and governance systems with accountable internal owners.', badge: 'Deploy' },
        ],
      },
    ],
    keyFindings: [
      'The strategic question is which layer of intelligence must be owned, not whether every team should own a foundation model',
      'The default founder sequence is to own lawful data, evaluations, interfaces, workflow, and feedback before taking on GPU and model-lifecycle burden',
      'Use the lowest intervention that meets verified outcome, latency, economic, and governance thresholds; prompting, retrieval, tools, skills, routing, tuning, self-hosting, and training can stack',
      'Retrieval addresses current knowledge, skills and harnesses address repeatable execution, and fine-tuning addresses repeated behavior; each requires its own evaluation design',
      'Model selection should optimize cost per verified successful outcome rather than token price or benchmark rank alone',
      'Open and proprietary models form a portfolio: open weights improve some control surfaces while frontier APIs can preserve capital and capability access',
      'Open weights are not automatically open source, cheap, safe, or compliant; licenses, recipes, operations, and deployment context remain decisive',
      'Unique data becomes defensible only when it is lawfully usable, high quality, outcome-relevant, hard to reproduce, and connected to a feedback loop',
      'In regulated AI, the product is a governed learning system with evidence across its lifecycle, not only a checkpoint',
      'Starlight packages the method as reusable substrate and self-serve implementation products that teams deploy inside their own architecture',
    ],
    faq: [
      { question: 'Should an AI startup build its own foundation model?', answer: 'Usually not at the beginning. Start with the lowest layer that reaches the required outcome and preserves capital. Train new capability only when a defensible capability gap, lawful data advantage, evaluation system, financing, and operating model make that responsibility rational.' },
      { question: 'When is retrieval better than fine-tuning?', answer: 'Retrieval is usually the first choice when information is current, private, attributable, or changes often. Fine-tuning is more appropriate when a stable, repeated behavior remains below the evaluation threshold after prompt, context, retrieval, tool, and harness improvements.' },
      { question: 'When should a team self-host an open-weight model?', answer: 'When deployment control, latency, privacy, sovereignty, availability, customization, or quality-adjusted economics justify owning the serving and model-operations burden. Verify the license, infrastructure utilization, security, updates, and staffing rather than assuming self-hosting is cheaper.' },
      { question: 'How should cloud and model platforms be compared?', answer: 'Compare the whole lifecycle: available models, tuning methods, artifact export, serving topology, regional processing, retention, networking, observability, accelerator access, commitments, and cost per verified success. Product names, pricing, and terms should be rechecked before implementation.' },
      { question: 'Does unique enterprise data mean the company should train a proprietary model?', answer: 'Not by itself. The organization needs lawful rights, usable quality, labels or outcome signals, task relevance, enough volume for the selected method, evaluation cases, and a path to operational feedback. Retrieval or a smaller adapted model may capture the advantage with less risk.' },
      { question: 'Is an open-weight model the same as open-source AI?', answer: 'No. Open weights describe access to model parameters. Open-source claims also depend on licenses and the availability of code, data, recipes, and other freedoms. Each artifact and restriction must be checked independently.' },
      { question: 'What does Starlight provide for this decision?', answer: 'Reusable substrate and implementation products such as evaluation contracts, decision schemas, routing patterns, governed skills, and model-operations components. Teams deploy the method themselves inside their own product and governance environment.' },
      { question: 'Is this legal or procurement advice?', answer: 'No. The hub explains architecture and evidence considerations. EU and regulated-sector decisions depend on the actual role, intended purpose, data, contract, jurisdiction, and deployment, and require current fact-specific professional review.' },
    ],
    relatedDomains: ['generative-ai', 'model-arena', 'agentic-evals', 'enterprise-ai', 'production-patterns', 'ai-security'],
    ...
    limitations: [
      'Provider features, model availability, pricing, licenses, retention terms, residency, and legal dates change and must be rechecked before implementation',
      'Quality and cost crossovers are workload-specific and require representative private evaluations, utilization assumptions, and complete operating costs',
      'Vendor experiments and technical reports describe vendor-reported behavior and are not independent comparative evidence',
      'Legal and regulated-sector summaries are educational and cannot determine obligations without the actual role, intended purpose, data, jurisdiction, and deployment',
      'No confidential client or rare-cohort case is included because anonymization alone may not control contractual, trade-secret, or re-identification risk',
    ],
    whatWeDontKnow: [
      'Which open and proprietary model portfolio will minimize cost per verified success for a specific workload after future model and price changes',
      'How quickly cross-provider artifact, trajectory, and evaluation portability will mature into durable standards',
      'Which self-serve decision and model-operations components will create the most leverage across founder, enterprise, and regulated-sector teams',
      'How EU implementation practice and sector guidance will evolve across amended AI Act dates and national enforcement',
    ],
  ...
  },
  {
    ...
    tldr: 'Agent Skills are becoming an operating layer for AI teams: metadata routes the agent, instructions encode workflow, references carry deep knowledge, scripts handle deterministic checks, and AI CoE governance turns individual workflows into reusable capability. The Agent Skill Standard makes that path explicit with a six-level maturity model.',
    icon: 'FileText',
    color: 'sky',
    category: 'ai-systems',
    highlights: [
      { stat: '3 levels', label: 'Progressive disclosure', source: 'Anthropic' },
      { stat: '6 levels', label: 'Skill maturity model (L0–L5)', source: 'Agent Skill Standard' },
      { stat: '5 tiers', label: 'Risk model for skill governance', source: 'Agent Skill Standard' },
    ...
    sections: [
      ...
      {
        title: 'The Agent Skill Standard',
        content: 'A skill is ready when it produces the intended result repeatedly, under representative conditions, with clear boundaries, visible assumptions, and a maintained owner. The Agent Skill Standard — an open spec stewarded by FrankX on top of Anthropic Agent Skills — encodes that readiness as a six-level maturity model, so a team can see exactly where a skill stands and what it needs next.',
        items: [
          { title: 'L0–L1 · Prompt to Documented', description: 'An ad-hoc instruction becomes a valid SKILL.md with one narrow job and trigger-rich description.', badge: 'Capture' },
          { title: 'L2–L3 · Referenced to Evaluated', description: 'Progressive disclosure plus three or more eval scenarios move a skill from luck to proof.', badge: 'Prove' },
          { title: 'L4–L5 · Governed to Composed', description: 'A registry row, risk tier, and rollback path — then safe composition with attestation and a sovereignty boundary.', badge: 'Scale' },
        ],
      },
    ],
    faq: [
    ...
    keyFindings: [
      ...
      'A six-level maturity model (L0 Prompt to L5 Composed) gives teams a shared vocabulary for where a skill stands and what it needs next',
    ],
    relatedDomains: ['enterprise-ai', 'mcp-ecosystem', 'ai-ops', 'multi-agent-systems', 'production-patterns'],
    relatedBlogPosts: ['/blog/ai-skills-operating-layer', '/blog/skill-maturity-model', '/blog/skills-vs-agents-vs-prompts-vs-mcp', '/blog/skill-libraries-ai-coe-governance', '/blog/building-custom-skills-acos', '/blog/why-everyone-needs-personal-ai-coe'],
  ...
  },
  {
    ...
    description: 'A practical map of enterprise agent architecture: bounded use cases, orchestration patterns, model gateways, observability, governance, and the evidence still missing from vendor-led adoption narratives.',
    tldr: 'Enterprise agent systems are moving from isolated demos into bounded production workflows, but public adoption estimates vary widely. The durable architecture questions are authority, observability, evaluation, data boundaries, and the cost of operating the system after launch.',
    icon: 'Building2',
    color: 'emerald',
    category: 'ai-systems',
    highlights: [
      { stat: 'Scope', label: 'Bounded production use', source: 'Architecture review' },
      { stat: 'Control', label: 'Decision rights', source: 'Architecture review' },
      { stat: 'Proof', label: 'Evaluation and observability', source: 'Architecture review' },
      { stat: 'Open', label: 'Long-term ROI', source: 'Research gap' },
    ],
    sections: [
      {
        title: 'From Pilot to Operating System',
        content: 'Public case studies, product releases, and industry surveys all point to growing enterprise experimentation with agents. They do not provide one trustworthy adoption rate. The more useful distinction is between a demo and an operating system with declared authority, owned data, evaluation, monitoring, and a team responsible after launch.',
        items: [
          { title: 'Pilot', description: 'Test whether a bounded task is useful and measurable before automating a wider process.', badge: 'Learn' },
          { title: 'Controlled production', description: 'Add permissions, human approval, logs, rollback, and explicit service ownership.', badge: 'Operate' },
          { title: 'Multi-agent workflow', description: 'Split work only when specialist roles or independent review improve the result.', badge: 'Compose' },
          { title: 'Governed portfolio', description: 'Reuse identity, policy, evaluation, and observability across approved systems.', badge: 'Scale' },
        ],
      },
      {
        title: 'Architecture Patterns Worth Comparing',
        content: 'Public reference architectures repeatedly use orchestrator-worker, hierarchical review, peer collaboration, and retrieval-led patterns. No independent dataset establishes one universal winner; the right pattern depends on task coupling, consequence, auditability, latency, and failure recovery.',
        items: [
          { title: 'Orchestrator-Worker', description: 'A coordinator delegates bounded tasks to specialists and reconciles the results.', badge: 'Directed' },
          { title: 'Hierarchical Review', description: 'Workers produce artifacts while supervisors apply domain-specific gates and escalation.', badge: 'Governed' },
          { title: 'Agentic Retrieval', description: 'A controller selects retrieval tools and search strategies within declared limits.', badge: 'Evidence-led' },
        ],
      },
      {
        title: 'Infrastructure Requirements',
        content: 'A production agent system typically needs model routing, identity and permission controls, traceable tool calls, evaluation, cost monitoring, rollback, and a deliberate memory policy. The exact stack depends on consequence and scale; none of these layers makes an unreliable workflow safe by itself.',
      },
    ],
    faq: [
      { question: 'How common are enterprise AI agents?', answer: 'Public estimates disagree and often mix pilots, embedded assistants, and autonomous workflows. Treat any single adoption percentage as directional unless its sample and definition are inspectable.' },
      { question: 'What is the best multi-agent architecture pattern?', answer: 'There is no universal winner. Orchestrator-worker is easy to inspect, hierarchical review adds specialist gates, and peer collaboration can help loosely coupled exploration. Consequence and failure recovery should decide.' },
      { question: 'What makes an enterprise agent production-ready?', answer: 'A bounded purpose, explicit decision rights, permission controls, evidence requirements, evaluation, observability, rollback, cost ownership, and a named human owner.' },
    ],
    keyFindings: [
      'Published adoption estimates are not directly comparable because they use different definitions of agent, application, pilot, and production.',
      'Architecture quality depends more on bounded authority, evidence, and failure recovery than on the number of agents.',
      'Orchestrator-worker, hierarchical review, peer collaboration, and agentic retrieval solve different coordination problems.',
      'Model gateways can simplify provider routing, but they do not replace evaluation, policy, or service ownership.',
      'Long-term operating cost and matched ROI remain weakly documented in public enterprise case studies.',
    ],
    ...
    status: 'active',
    evidenceGrade: 'C',
    evidenceNote: 'Mixed official documentation, industry reporting, and architectural synthesis',
    limitations: [
      'Market forecasts and adoption surveys use inconsistent definitions and are often vendor-led.',
      'Public case studies favor successful deployments and disclose limited operating detail.',
      'Architecture recommendations are synthesis, not matched causal comparisons.',
    ],
    whatWeDontKnow: [
  ...
  },
  {
    ...
    description: 'A source-linked comparison of LangGraph, CrewAI, AutoGen, OpenAI Agents SDK, and Pydantic AI by control model, state, handoffs, typing, observability, and production fit—not invented market share.',
    tldr: 'The main framework choice is architectural: explicit graphs, role-based teams, conversational handoffs, provider-native agents, or typed application code. No independent source establishes a trustworthy market-share ranking, and release velocity makes durable comparisons more useful than popularity claims.',
    icon: 'Network',
    color: 'violet',
    category: 'ai-systems',
    highlights: [
      { stat: 'Graph', label: 'Explicit state', source: 'Official documentation' },
      { stat: 'Roles', label: 'Team abstraction', source: 'Official documentation' },
      { stat: 'Handoffs', label: 'Agent routing', source: 'Official documentation' },
      { stat: 'Types', label: 'Application control', source: 'Official documentation' },
    ],
    sections: [
      {
        title: 'Framework Landscape',
        content: 'These five projects represent different ways to coordinate agent work. The useful comparison is not an unsupported popularity ranking; it is how each framework represents state, handoffs, tools, human review, and failure.',
        items: [
          { title: 'LangGraph', description: 'Graph-based state and explicit transitions for workflows that need inspectable control.', badge: 'Graph' },
          { title: 'CrewAI', description: 'Role and crew abstractions for work that maps naturally to specialist responsibilities.', badge: 'Roles' },
          { title: 'AutoGen', description: 'Conversation-driven coordination patterns for experimentation and research workflows.', badge: 'Dialogue' },
          { title: 'OpenAI Agents SDK', description: 'Provider-native tools, handoffs, tracing, and guardrails in the OpenAI ecosystem.', badge: 'Native' },
          { title: 'Pydantic AI', description: 'Typed Python application patterns with explicit models, tools, and validation.', badge: 'Typed' },
        ],
      },
      {
        title: 'Selection Criteria',
        content: 'Choose from the workflow’s constraints: how explicit the state must be, who may hand off to whom, how tools are authorized, how results are typed and evaluated, which provider dependencies are acceptable, and how the team will debug failures.',
        items: [
          { title: 'Explicit workflow state', description: 'Compare graph semantics, persistence, checkpoints, and replay.', badge: 'Control' },
          { title: 'Role-based collaboration', description: 'Inspect delegation rules, shared context, and termination behavior.', badge: 'Coordination' },
          { title: 'Provider integration', description: 'Account for model, tracing, and deployment dependencies.', badge: 'Stack' },
          { title: 'Typed application code', description: 'Prefer explicit schemas and validation when downstream systems depend on the result.', badge: 'Reliability' },
        ],
      },
      {
        title: 'Convergence Trends',
        content: 'Many frameworks now expose state, tool integration, tracing, and human-in-the-loop controls. Their semantics and maturity still differ, so comparisons should use a real workflow and failure test rather than a feature checklist.',
      },
    ],
    faq: [
      { question: 'Which multi-agent framework has the largest market share?', answer: 'No independent, methodologically transparent source establishes a reliable market-share ranking. Repository activity, downloads, survey responses, and enterprise deployment are different measures.' },
      ...
      { question: 'Which framework is best for production?', answer: 'The answer depends on state, control, typing, provider, observability, and team constraints. Test candidates against one representative workflow, including retries, invalid tool output, human escalation, and replay.' },
    ],
    keyFindings: [
      'No independent source establishes reliable market share across multi-agent frameworks.',
      'LangGraph emphasizes explicit graph state; CrewAI emphasizes role and team abstractions.',
      'AutoGen explores conversation-led coordination, while OpenAI Agents SDK provides provider-native handoffs and tracing.',
      'Pydantic AI keeps model and tool interactions close to typed application code.',
      'A representative failure test is more informative than a generic feature or popularity ranking.',
    ],
    ...
    status: 'active',
    evidenceGrade: 'C',
    evidenceNote: 'Official framework documentation plus editorial comparison; no independent market-share study',
    limitations: [
      'Official documentation explains intended behavior but does not provide independent comparative outcomes.',
      'Framework releases change quickly; production behavior should be re-tested against current versions.',
    ],
    whatWeDontKnow: [
  ...
  },
  {
    ...
    description: 'A practical map of retrieval, evaluation, observability, model gateways, and deployment controls, with provisional performance claims removed until comparable evidence is available.',
    tldr: 'Retrieval, tracing, evaluation, and model routing are useful production patterns, not universal prescriptions. Their value depends on the corpus, query mix, model, latency budget, and failure cost; test each pattern against a representative evaluation set.',
    icon: 'Cpu',
    color: 'cyan',
    category: 'ai-systems',
    highlights: [
      { stat: 'RAG', label: 'Retrieval patterns', source: 'Official documentation' },
      { stat: 'Eval', label: 'Representative test sets', source: 'Engineering practice' },
      { stat: 'Trace', label: 'Inspectable execution', source: 'Engineering practice' },
      { stat: 'Route', label: 'Provider control', source: 'Official documentation' },
    ],
    sections: [
      {
        title: 'RAG Architecture Choices',
        content: 'Retrieval systems range from simple vector search to hybrid retrieval, reranking, query rewriting, and agent-selected strategies. Added complexity does not guarantee improvement; every change should be measured on the same corpus, query set, and answer-quality rubric.',
        items: [
          { title: 'Direct retrieval', description: 'Query → embed → retrieve → provide context → generate.', badge: 'Baseline' },
          { title: 'Hybrid and reranked retrieval', description: 'Combine lexical and semantic search, then rerank candidates.', badge: 'Candidate' },
          { title: 'Agent-selected retrieval', description: 'Choose search tools or strategies according to the query and policy.', badge: 'Conditional' },
        ],
      },
      {
        title: 'Observability Stack',
        content: 'Production teams commonly combine traces, evaluations, and operational monitoring. LangSmith, Langfuse, Weave, and Phoenix expose different trade-offs; no public evidence here supports a universal ranking.',
        items: [
          { title: 'LangSmith', description: 'Enterprise-grade tracing from LangChain. Deep integration with LangGraph.', badge: 'Enterprise' },
          { title: 'Langfuse', description: 'Open-source tracing and evaluation with self-hosting options.', badge: 'Open Source' },
      ...
      },
      {
        ...
        content: 'A model gateway can centralize provider routing, failover, cost tracking, and rate limits. It adds another operational dependency, so the decision should follow real multi-provider or governance needs rather than architecture fashion.',
      },
    ],
    faq: [
      { question: 'Should every production AI app use RAG?', answer: 'No. RAG is useful when answers need external or frequently changing knowledge. It adds retrieval, ranking, freshness, access-control, and evaluation failure modes that may be unnecessary for other tasks.' },
      { question: 'Does hybrid search always improve results?', answer: 'No. Hybrid retrieval can help when exact terms and semantic similarity both matter, but the effect depends on the corpus and queries. Measure it against a fixed evaluation set.' },
      { question: 'What belongs in an AI observability stack?', answer: 'At minimum: traceable model and tool calls, evaluation results, latency, cost, errors, policy events, and enough context to reproduce or explain a failed run without retaining unnecessary sensitive data.' },
    ],
    keyFindings: [
      'RAG is appropriate when external knowledge is needed; it is not a default requirement for every AI application.',
      'Hybrid search and reranking should be evaluated on the same corpus and query set as the baseline.',
      'Tracing, evaluation, and operational monitoring answer different questions and should be designed together.',
      'No public evidence in this brief supports a universal ranking of observability vendors.',
      'Model gateways help when routing, policy, or provider resilience justify the added dependency.',
    ],
    ...
    status: 'active',
    evidenceGrade: 'C',
    evidenceNote: 'Official product documentation and architectural synthesis; comparative outcome evidence is limited',
    limitations: [
      'Sources lean heavily toward Oracle OCI documentation',
      'Comparative retrieval and observability outcomes vary by dataset, model, workflow, and methodology',
    ],
    whatWeDontKnow: [
  ...
  },
  {
    ...
    subtitle: 'Evidence, limitations, and safety boundaries for AI-supported care',
    description: 'A source map for AI-supported mental health tools, covering systematic reviews, bounded randomized trials, ethics research, and regulatory questions. It does not rank products, generalize one intervention to every chatbot, or offer clinical advice.',
    tldr: 'Some studies report benefits for specific, bounded AI-supported interventions, but the evidence varies by tool, comparator, duration, population, and outcome. Those results do not establish that consumer chatbots are interchangeable with studied clinical systems. Safety, escalation, privacy, and human oversight remain central design constraints, especially when a person may be in crisis or needs diagnosis or treatment.',
    icon: 'Heart',
    color: 'sky',
    category: 'health-science',
    highlights: [
      { stat: 'Trials', label: 'Read each intervention in its own study context', source: 'Nature Communications Medicine' },
      { stat: 'Review', label: 'Chatbot evidence remains heterogeneous', source: 'PMC' },
      { stat: 'Ethics', label: 'Safety failures remain a material risk', source: 'Brown University' },
      { stat: 'Policy', label: 'Clinical use needs explicit governance', source: 'UK Parliament POST' },
    ],
    sections: [
      {
        title: 'What the evidence can support',
        content: 'Randomized trials and systematic reviews provide a legitimate basis for studying some AI-supported mental health interventions. The responsible unit of analysis is the specific intervention, population, comparator, outcome, and study period—not the broad category “AI therapy.”',
        items: [
          { title: 'Bounded interventions', description: 'A result applies first to the tested protocol and participants. It should not be transferred automatically to a different product or model.', badge: 'Study-specific' },
          { title: 'Outcome choice', description: 'Engagement, self-reported symptoms, clinician-rated outcomes, and long-term functioning answer different questions.', badge: 'Not equivalent' },
          { title: 'Comparator quality', description: 'Wait-list, information material, usual care, and active therapy controls set very different evidentiary bars.', badge: 'Read closely' },
          { title: 'Duration', description: 'Short trials can identify an early signal without establishing durability, relapse prevention, or safe long-term use.', badge: 'Open question' },
        ],
      },
      {
        title: 'Why the evidence does not travel automatically',
        content: 'Mental health chatbots, clinician-facing systems, passive sensing, and generative companions are different intervention classes. Model behavior can also change after a study through prompt, policy, retrieval, or model updates, so a published result may not describe the current product.',
        items: [
          { title: 'Version drift', description: 'The system evaluated in a paper may differ materially from the system a person encounters today.', badge: 'Re-verify' },
          { title: 'Population limits', description: 'Age, language, diagnosis, severity, access to care, and culture can change both benefit and risk.', badge: 'Context' },
          { title: 'Deployment setting', description: 'A supervised clinical workflow is not equivalent to an unsupervised consumer conversation.', badge: 'Boundary' },
        ],
      },
      {
        title: 'Safety, ethics, and escalation',
        content: 'Independent ethics research documents failure modes including inappropriate responses, reinforcement of harmful beliefs, unclear accountability, and weak crisis handling. Privacy and consent matter because mental health conversations can contain unusually sensitive data.',
        items: [
          { title: 'Crisis handling', description: 'A system needs tested escalation behavior and must not present itself as emergency or professional care.', badge: 'Hard gate' },
          { title: 'Clinical claims', description: 'Diagnosis, treatment, efficacy, and regulatory claims require direct, current evidence for the named system and indication.', badge: 'Verify' },
          { title: 'Privacy', description: 'Collection, retention, secondary use, and deletion of sensitive conversations should be explicit and inspectable.', badge: 'Consent' },
        ],
      },
      {
        title: 'How to read this brief',
        content: 'Use the source list to inspect study design, limitations, and ethical critiques. Do not use this page to choose treatment or delay professional care. A person who may be in immediate danger needs qualified local emergency or crisis support, not a website or chatbot.',
      },
    ],
    faq: [
      { question: 'Do AI mental health tools work?', answer: 'Some specific interventions have encouraging results in bounded studies. That evidence cannot be generalized to every chatbot, population, outcome, or current product version.' },
      { question: 'Can an AI system replace a therapist?', answer: 'The sources indexed here do not establish AI as a general replacement for qualified care. Human oversight, escalation, and clinical accountability remain essential.' },
      { question: 'What is this page for?', answer: 'It is a research map: a way to inspect the evidence, limitations, ethics findings, and unanswered questions behind a fast-moving category.' },
    ],
    keyFindings: [
      'Evidence must be attributed to the exact intervention, comparator, population, outcome, and study period',
      'A systematic review can establish a research signal without making every product or chatbot equivalent',
      'Product and model updates can weaken the connection between a published trial and present-day behavior',
      'Ethics, privacy, escalation, and accountability are part of efficacy—not secondary product details',
      'Consumer support, clinician-facing tools, passive sensing, and generative companions require different evaluations',
      'This research category is not a substitute for diagnosis, treatment, emergency support, or qualified care',
    ],
    ...
    status: 'active',
    evidenceGrade: 'C',
    evidenceNote: 'Mixed intervention classes and study designs; conclusions remain study-specific',
    limitations: [
      'The registry mixes systematic reviews, individual trials, ethics research, policy analysis, and industry material',
      'Product names can persist while the underlying model, safeguards, prompts, or escalation policy changes',
      'Short follow-up periods do not establish durable benefit or safe long-term reliance',
      'Negative results and safety incidents may be underreported',
    ],
    whatWeDontKnow: [
      'Which benefits persist after the intervention ends',
      'How outcomes and harms differ across demographics, languages, cultures, and levels of clinical need',
      'How reliably deployed systems recognize crisis, delusion, dependency, or requests beyond their competence',
      'How often reliance on a consumer system delays or changes access to qualified care',
    ],
  ...
  },
  {
    ...
    category: 'models-tools',
    highlights: [
      { stat: '3', label: 'Locked briefs', source: 'This run' },
      { stat: '1', label: 'Backend that returned pixels', source: 'Grok Imagine' },
      { stat: '3', label: 'Backends held', source: 'NB / GPT Image / FAL' },
      { stat: '1280×720', label: 'Grok output size', source: 'JPEG bytes' },
    ],
    sections: [
      {
        title: 'How the image path actually works',
        content: 'Grok 4.6 is the text model. Images come from a separate Grok Imagine backend under the same xAI OAuth. Hermes config can name grok-imagine-image-quality; this run\'s tool results named grok-imagine-image. CDN said PNG; bytes were JPEG 1280×720.',
        items: [
          { title: 'Call', description: 'Hermes image_generate with prompt + landscape.', badge: 'Runtime' },
          { title: 'Trust the tool result', description: 'Record reported model, not config.yaml.', badge: 'Rule' },
          { title: 'Save from magic bytes', description: 'JFIF from a .png URL becomes .jpg.', badge: 'Release' },
        ],
      },
      {
        title: 'Results',
        content: 'Still-life matched. Interior added a second chair and a lamp that reads lit. The droid brief returned a cream mascot. Nano Banana key file existed but Gemini returned 400 invalid key. GPT Image and FAL had no keys in the searched env.',
        items: [
          { title: 'Still-life', description: 'Brief-fit 5. Gold ring present. Upper half warmer than matte black.', badge: 'Pass' },
          { title: 'Interior', description: 'Brief-fit 3. Extra chair. Lamp looks on. No people or titles.', badge: 'Drift' },
          { title: 'Droid', description: 'Brief-fit 4. Cute, not mechanical.', badge: 'Partial' },
          { title: 'Other APIs', description: 'HOLD — no pixels.', badge: 'Hold' },
        ],
      },
    ],
    keyFindings: [
      'Grok Imagine is a separate image backend from Grok 4.6 text',
      'Configured quality model id was not the runtime model in this session',
      'CDN content-type can disagree with file magic',
      'A second-model comparison requires a backend that actually returns bytes',
      'Count and on/off states still need a human recount pass',
    ],
    faq: [
      { question: 'Did Grok Imagine beat Nano Banana?', answer: 'Not measured. Nano Banana rejected the stored Gemini key.' },
      { question: 'Is this a Model Arena round?', answer: 'No. Model Arena is receipt-gated text and agent cards. This is a media bake-off with its own receipt.' },
      { question: 'Where are the files?', answer: '/research/image-bakeoff-2026-08-14/ plus receipt.json.' },
    ],
    relatedDomains: ['grok-4-6', 'ai-creative-tools', 'generative-ai', 'model-arena'],
    relatedBlogPosts: ['/blog/grok-imagine-bakeoff-2026', '/blog/grok-4-6-analysis-2026'],
    publishedAt: '2026-08-15',
    lastUpdated: '2026-08-15',
    sourceCount: 3,
    status: 'active',
    evidenceGrade: 'B',
    evidenceNote: 'First-party run plus failed-backend holds. n=1. No second renderer pixels.',
    limitations: [
    ...
    whatWeDontKnow: [
      'Whether grok-imagine-image-quality changes these three briefs',
      'How Nano Banana would score on the same locked prompts with a valid key',
    ],
    lastVerified: '2026-08-15',
  },
  {
    slug: 'qwen-3-8',
    title: 'Qwen3.8 Architecture and Routing',
    subtitle: 'One model family, three deployment surfaces, and two different weight licenses',
    description:
      'A primary-source brief on Qwen3.8-Max, Qwen3.8-2.4T-A95B, and Qwen3.8-27B. Covers architecture, access, licenses, vendor-reported benchmarks, deployment economics, and the AI Architect routing decision.',
    tldr:
      'Treat Qwen3.8 as three deployment choices. Hosted Qwen3.8-Max is a $2/$6 frontier challenger with a 1M context default. Qwen3.8-27B is the practical ownership lane: dense, multimodal, and Apache 2.0. The 2.4T-A95B weights expose the Max-class text backbone but use the separate Qwen3.8-Max License and require cluster-scale infrastructure. No Qwen3.8 Starlight Model Arena receipt exists as of 15 August 2026.',
    icon: 'Cpu',
    color: 'orange',
    category: 'models-tools',
    highlights: [
      { stat: '27B', label: 'Apache 2.0 dense multimodal checkpoint', source: 'Qwen model card' },
      { stat: '2.4T / 95B', label: 'Max backbone total / active parameters', source: 'Qwen model card' },
      { stat: '$2 / $6', label: 'Hosted Max input / output per 1M', source: 'Qwen Cloud' },
      { stat: '0', label: 'Starlight arena receipts', source: 'Model Arena receipt set' },
    ],
    sections: [
      {
        title: 'What shipped',
        content: 'Qwen3.8-Max is the managed vision-language flagship. The downloadable 2.4T-A95B artifact is its text-only, always-thinking backbone. The 27B release is a separate dense vision-language checkpoint designed for practical deployment. The shared family name should not erase those contract differences.',
        items: [
          { title: 'Hosted Max', description: '2.4T total / 95B active MoE, 1M default context, 131K max output, vision and optional non-thinking mode.', badge: 'API' },
          { title: 'A95B weights', description: '2.4T total / 95B active, 512 experts, 262K native context, text-only and always thinking.', badge: 'Cluster' },
          { title: '27B weights', description: 'Dense causal LM with vision encoder, image and video understanding, 262K native context.', badge: 'Own' },
          { title: 'Reasoning control', description: 'Low, medium, and xhigh effort; 27B can disable thinking while the raw A95B checkpoint cannot.', badge: 'Route' },
        ],
      },
      {
        title: 'The license split',
        content: 'Qwen3.8-27B is Apache 2.0. Qwen3.8-2.4T-A95B is labeled qwen3.8-max and carries a custom license with attribution and commercial-service conditions. The managed Max API is governed by service terms. “Qwen3.8 is Apache 2.0” is therefore too broad.',
        items: [
          { title: '27B', description: 'Apache 2.0 open weights; the cleanest commercial adaptation and sovereign-deployment lane.', badge: 'Apache' },
          { title: 'A95B', description: 'Custom Qwen3.8-Max License; review thresholds for large products, MaaS, and AI work assistants.', badge: 'Custom' },
          { title: 'Hosted Max', description: 'API service, not a weight-license grant. Regional and contractual controls still apply.', badge: 'Service' },
          { title: 'Terminology', description: 'Open weights do not include the complete data and reproducible training recipe.', badge: 'Precise' },
        ],
      },
      {
        title: 'What the launch scores support',
        content: 'Qwen reports Max at 86.6 on Terminal-Bench 2.1, 67.7 on SWE-bench Pro, and 74.8 on CoWorkBench. It reports 27B at 73.0, 61.7, and 70.7 on those rows. These measurements justify task-specific evaluation. They do not establish a universal winner because the release tables include vendor harnesses, in-house benchmarks, corrected task sets, and model judges.',
        items: [
          { title: 'Max coding', description: 'Terminal-Bench 2.1 86.6 and SWE-bench Pro 67.7, vendor-reported.', badge: 'Vendor' },
          { title: '27B coding', description: 'Terminal-Bench 2.1 73.0 and SWE-bench Pro 61.7, vendor-reported.', badge: 'Vendor' },
          { title: 'Cowork', description: 'CoWorkBench 74.8 for Max and 70.7 for 27B; Qwen identifies it as in-house.', badge: 'In-house' },
          { title: 'Arena status', description: 'No pinned Qwen3.8 run or JSON receipt in the Starlight arena.', badge: 'Hold' },
        ],
      },
      {
        title: 'AI Architect routing decision',
        content: 'Add Max as a challenger for frontier coding, research, and office agents. Use 27B when privacy, adaptation, predictable infrastructure, or Apache 2.0 rights are the deciding constraints. Reserve A95B for model providers and cluster-scale R&D. Promote only after representative tasks measure quality, latency, retries, and reviewer cost.',
        items: [
          { title: 'Frontier challenger', description: 'Qwen3.8-Max behind the same task suite and acceptance tests as the current default.', badge: 'Trial' },
          { title: 'Sovereign multimodal', description: 'Qwen3.8-27B through vLLM or SGLang with explicit data and reasoning-retention controls.', badge: 'Deploy' },
          { title: 'Cluster research', description: 'A95B only with infrastructure, license, and utilization review.', badge: 'Specialist' },
          { title: 'Expensive failure', description: 'Independent reviewer, human approval, and auditable receipts remain mandatory.', badge: 'Govern' },
        ],
      },
    ],
    keyFindings: [
      'Qwen3.8-Max is a managed 2.4T / 95B-active vision-language service with 1M context and $2/$6 list pricing',
      'Qwen3.8-27B is a dense native vision-language checkpoint under Apache 2.0',
      'Qwen3.8-2.4T-A95B is text-only, always thinking, and licensed under the custom Qwen3.8-Max License',
      'The downloadable checkpoints have 262K native context; roughly 1M is an extension mode',
      'Published coding, cowork, and computer-use scores are vendor-reported and method-dependent',
      'No Qwen3.8 result belongs on the Starlight Model Arena scoreboard until a pinned receipt exists',
    ],
    faq: [
      { question: 'Which Qwen3.8 model is Apache 2.0?', answer: 'Qwen3.8-27B. The 2.4T-A95B checkpoint uses the separate Qwen3.8-Max License.' },
      { question: 'Is Qwen3.8-Max open weight?', answer: 'The managed Max service is an API. Its A95B text backbone is downloadable under a custom license, while the production service adds vision, non-thinking support, tools, and a 1M default context.' },
      { question: 'Which model should a normal product team test?', answer: 'Test hosted Max for frontier capability and 27B for controlled deployment. Avoid self-hosting A95B unless operating large-model infrastructure is already a core competence.' },
      { question: 'Are the benchmark results independent?', answer: 'No. The current launch rows are published on Qwen model cards and include vendor runs, in-house suites, corrected task sets, and model judges.' },
      { question: 'Does the Model Arena rank Qwen3.8?', answer: 'Not yet. The arena is receipt-gated, and no pinned Qwen3.8 receipt existed on 15 August 2026.' },
    ],
    relatedDomains: ['ai-model-strategy', 'model-arena', 'agentic-evals', 'generative-ai', 'coding-assistants'],
    relatedBlogPosts: ['/blog/qwen-3-8-analysis-2026', '/blog/qwen3-max-analysis-2026'],
    publishedAt: '2026-08-15',
    lastUpdated: '2026-08-15',
    sourceCount: 5,
    status: 'active',
    evidenceGrade: 'C',
    evidenceNote: 'Primary vendor model cards, service card, and license text. Benchmark values are not independent FrankX measurements.',
    limitations: [
      'No first-party FrankX inference run or Starlight arena receipt',
      'No independent composite benchmark was available at publication',
      'Hosted availability, terms, and performance may vary by region',
      'The article does not provide legal advice on the custom license',
    ],
    whatWeDontKnow: [
      'Quality-adjusted cost versus current FrankX routing defaults',
      'Long-context retrieval quality at the extended 1M setting',
      'Quantized 27B quality and latency on the target deployment hardware',
      'Whether launch computer-use scores reproduce in the Starlight harness',
    ],
    lastVerified: '2026-08-15',
  },
  {
    slug: 'grok-4-6',
    title: 'Grok 4.6',
    subtitle: 'Same-scale agent refresh: what changed from 4.5, and what remains untested here',
    description:
      'A source-led brief on xAI Grok 4.6 (released 12 August 2026). Covers the official training story, API contract, pricing cliff, vendor and Artificial Analysis scores versus Grok 4.5 and published flagships, and the hard boundary that the Starlight Model Arena has not run this model.',
    tldr:
      'Grok 4.6 is a post-training refresh of Grok 4.5, not a documented new base model. Official High scores put it at 61 on the Artificial Analysis Intelligence Index, matching GPT-5.6 Sol, with the largest published gains on long-running agent and knowledge-work evals. List price stays $2/$6 under 200k prompt tokens. Starlight Model Arena has no Grok 4.6 receipt as of 2026-08-14.',
    icon: 'Cpu',
    color: 'amber',
    category: 'models-tools',
    highlights: [
      { stat: '61', label: 'AA Intelligence Index (High)', source: 'xAI + Artificial Analysis' },
      { stat: '+227', label: 'GDPVal-AA v2 vs Grok 4.5', source: 'xAI announcement table' },
      { stat: '$2/$6', label: 'Input/output under 200k tokens', source: 'xAI docs' },
      { stat: '0', label: 'SIS arena receipts for 4.6', source: 'tools/arena/runs' },
    ],
    sections: [
      {
        title: 'What shipped',
        content: 'xAI released Grok 4.6 on 12 August 2026 as a same-foundation follow-on to Grok 4.5. The public pitch is long-running agents and stronger first-pass interactive and visual work, with more self-testing on longer trajectories. Availability listed in the announcement includes Cursor, Grok Build, the xAI API, OpenRouter, Vercel, and Cloudflare.',
        items: [
          { title: 'Model id', description: 'grok-4.6 on the xAI API. Text and image in, text out, 500k context, knowledge cutoff 1 February 2026.', badge: 'Contract' },
          { title: 'Reasoning knobs', description: 'low, medium, high (default), and a new xhigh effort setting.', badge: 'API' },
          { title: 'Price cliff', description: '$2/$0.50/$6 per 1M tokens below 200k prompt tokens; $4/$1/$12 above. Fast variant is 2x.', badge: 'Cost' },
          { title: 'Training story', description: 'Vendor-stated: longer supplemental run, regenerated SFT, agentic RL. Parameter count still undisclosed.', badge: 'Vendor' },
        ],
      },
      {
        title: 'Published scores, labeled',
        content: 'The announcement table compares Grok 4.6 High with Grok 4.5 High, GPT-5.6 Sol Max, and Fable 5 Max. Artificial Analysis independently reports 61 on the Intelligence Index and notes turn-efficient Briefcase runs. Those are not Starlight Model Arena results.',
        items: [
          { title: 'Composite intelligence', description: 'AA Index 61, +5 vs Grok 4.5, tied with GPT-5.6 Sol, behind Claude Opus 5 (63) and Fable 5 (62) on AA.', badge: 'AA / vendor' },
          { title: 'Agent and office work', description: 'GDPVal-AA 1753 and AA-Briefcase 1577 are the largest published jumps versus 4.5.', badge: 'Vendor / AA' },
          { title: 'Coding rows', description: 'DeepSWE and Terminal-Bench 3.0 improve versus 4.5 but still trail Sol/Fable on the same vendor table.', badge: 'Vendor' },
          { title: 'Efficiency', description: 'AA reports ~53 Briefcase turns versus ~103 for Opus 5 max. Confirm in your own harness.', badge: 'AA' },
        ],
      },
      {
        title: 'How this maps onto FrankX surfaces',
        content: 'The journal and catalog can carry a sourced brief immediately. The Model Arena cannot invent a winner. The SIS harness dispatches Claude Code Agent model overrides. Until a non-Claude pin exists and a JSON receipt is written, Grok 4.6 stays off the arena scoreboard.',
        items: [
          { title: 'Research brief', description: 'This domain plus the dated analysis article.', badge: 'Live' },
          { title: 'LLM Hub', description: 'Registry entry for routing and pricing, marked with sources.', badge: 'Catalog' },
          { title: 'Model Arena', description: 'Receipt-gated. No 4.6 file in tools/arena/runs.', badge: 'Hold' },
          { title: 'Next eval', description: 'Extend the arena dispatcher or run a separate pinned bake-off, then project the receipt.', badge: 'Queued' },
        ],
      },
      {
        title: 'Routing implications',
        content: 'Use Grok 4.6 as the current xAI flagship for long agent loops that fit the $2/$6 band. Keep Claude on SIS-native evals. Do not recycle Grok 4.1 or 4.3 coding scores as 4.6 evidence. Watch cache pricing and the 200k prompt cliff.',
        items: [
          { title: 'New xAI work', description: 'Default grok-4.6, reasoning high, set a prompt cache key.', badge: 'Default' },
          { title: 'Stamina failures on 4.5', description: 'Re-run the same loop on 4.6 before changing architecture.', badge: 'Upgrade' },
          { title: 'Judgment / SIS cards', description: 'Stay on the models that already have receipts.', badge: 'Hold' },
          { title: 'Long context', description: 'Budget $4/$12 once prompts cross 200k tokens.', badge: 'Cliff' },
        ],
      },
    ],
    keyFindings: [
      'Grok 4.6 is documented as a same-scale SFT and RL refresh of Grok 4.5, not a confirmed new base-model size',
      'Official High scores move the AA Intelligence Index from 56 to 61 and match GPT-5.6 Sol on that composite',
      'The largest published gains versus 4.5 sit on agent and knowledge-work evals, not on every coding row',
      'List price is unchanged at $2/$6 under 200k prompt tokens; cached input rose to $0.50',
      'Artificial Analysis reports higher turn efficiency on AA-Briefcase than Claude Opus 5 max; that is independent of SIS',
      'The Starlight Model Arena has no Grok 4.6 receipt and therefore records no battle winner',
      'Vendor DeepSWE and Terminal-Bench 3.0 rows still favor GPT-5.6 Sol and Fable 5 on the launch table',
    ],
    faq: [
      { question: 'Is Grok 4.6 a new foundation model?', answer: 'Not according to xAI. The announcement describes longer supplemental training and regenerated SFT and RL on the Grok 4.5 foundation. Parameter count is not officially disclosed.' },
      { question: 'Does Grok 4.6 beat GPT-5.6 Sol?', answer: 'On the Artificial Analysis Intelligence Index the published score is a tie at 61. Several vendor coding and terminal rows still favor Sol. Treat beat as the wrong verb.' },
      { question: 'What does the Starlight Model Arena say?', answer: 'Nothing yet. Arena pages only publish JSON receipts. No Grok 4.6 receipt exists as of 14 August 2026.' },
      { question: 'What is the API price?', answer: '$2 input and $6 output per million tokens below 200k prompt tokens, doubling above that band. Cached input is $0.50. Recheck the live pricing page before budgeting.' },
      { question: 'Should every agent switch to Grok 4.6?', answer: 'Switch new xAI workloads and 4.5 loops that were dying on stamina. Do not rip out Claude or Sol routes that already have measured receipts in your harness.' },
    ],
    relatedDomains: ['image-generation-bakeoff', 'generative-ai', 'model-arena', 'agent-benchmarks', 'agentic-evals', 'coding-assistants', 'ai-model-strategy'],
    relatedBlogPosts: ['/blog/grok-4-6-analysis-2026', '/blog/grok-imagine-bakeoff-2026', '/blog/grok-4-3-analysis-2026'],
    publishedAt: '2026-08-14',
    lastUpdated: '2026-08-14',
    sourceCount: 6,
    status: 'active',
    evidenceGrade: 'B',
    evidenceNote: 'Official announcement, official API docs, and one independent composite (Artificial Analysis). No peer-reviewed paper and no first-party SIS receipt.',
    limitations: [
      'Vendor benchmark rows are not a head-to-head run inside the Starlight harness',
      'Parameter count remains undisclosed',
      'Cached-input price increased versus Grok 4.5; older cost models are stale',
      'Company naming (xAI / SpaceXAI) follows the retrieved pages and may change',
    ],
    whatWeDontKnow: [
      'How Grok 4.6 scores on the existing SIS arena fixtures',
      'Whether xhigh changes quality enough to justify the extra tokens on our tasks',
      'Whether the Briefcase turn-efficiency result replicates in Hermes or Claude Code',
    ],
  ...
  },
  {
    ...
    tldr: 'Claude Opus 4.6 leads ARC-AGI-2 (68.8%) and Terminal-Bench (65.4%) as of February 2026. Its 67% price cut to $5/$25 makes it competitive with mid-tier models. Grok 4.6 is the current xAI flagship as of 12 August 2026 (AA Index 61, vendor/AA). Older Grok 4.1 context claims are historical. The market is splitting into reasoning specialists (Claude, GPT), multimodal leaders (Gemini), and open-source alternatives (Llama, DeepSeek).',
    icon: 'Sparkles',
    color: 'violet',
    category: 'models-tools',
    highlights: [
