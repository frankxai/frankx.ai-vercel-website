...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    relatedDomains: ['generative-ai', 'model-arena', 'agent-benchmarks', 'agentic-evals', 'coding-assistants', 'ai-model-strategy'],
    relatedBlogPosts: ['/blog/grok-4-6-analysis-2026', '/blog/grok-4-3-analysis-2026'],
