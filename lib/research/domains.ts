...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    "highlights": [
      {
        "stat": "Personal Mesh",
        "label": "Unified decentralized data mesh across health, calendar, finance, and knowledge",
        "source": "FrankX Personal Data Mesh Architecture"
      },
      {
        "stat": "4 Hours/Day",
        "label": "Cognitive load and administrative time reclaimed for sovereign deep creation",
        "source": "Creator OS Case Studies"
      },
      {
        "stat": "Biometric Loop",
        "label": "Adapting daily work schedules dynamically based on HRV recovery scores",
        "source": "Health Telemetry Integration"
      },
      {
        "stat": "100% Private",
        "label": "Local-first encrypted data storage protecting personal journals and finances",
        "source": "Sovereign Privacy Standards"
      }
    ],
    "sections": [
      {
        ...
        "items": [
          {
            "title": "Health & Recovery Telemetry",
            "description": "Ingests sleep stages, resting heart rate, and HRV scores to calibrate daily cognitive exertion limits.",
            "badge": "Health"
          },
          {
            "title": "Autonomous Calendar & Focus Protection",
            "description": "Defends 4-hour morning deep-work blocks, automatically declining low-priority meetings.",
            "badge": "Calendar"
          },
          {
            "title": "Financial Cash Flow Ledger",
            "description": "Aggregates multi-stream digital product revenue, Stripe payouts, and capital investments into a real-time net-worth ledger.",
            "badge": "Finance"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "title": "Morning Alignment Pulse (L1/L2)",
            "description": "Summarizes critical overnight research, checks biometrics, and frames the day's single highest-leverage creation goal.",
            "badge": "Morning"
          },
          {
            "title": "Deep Work Sprint (L3 Production)",
            "description": "Human provides creative soul and architecture; autonomous agents execute coding, formatting, and rendering in parallel.",
            "badge": "Sprint"
          },
          {
            "title": "Evening Reflection & Consolidation (L6)",
            "description": "Logs daily lessons into episodic memory, updates the personal knowledge vault, and shuts down work notifications.",
            "badge": "Evening"
          }
        ]
      },
      {
        ...
        "items": [
          {
            "title": "Local-First SQLite / Markdown Storage",
            "description": "Guarantees that your life operating system works 100% offline without sending personal journals to third parties.",
            "badge": "LocalFirst"
          },
          {
            "title": "Ethical Anti-Addiction Guardrails",
            "description": "Blocks algorithmic dopamine rabbit holes, doomscrolling feeds, and dark UX patterns.",
            "badge": "Guardrails"
          },
          {
            "title": "The Human Soul + Machine Muscle Principle",
            "description": "Human provides consciousness, intention, taste, and empathy; agents handle repetitive analytical and execution labor.",
            "badge": "Soul"
          }
        ]
      }
    ...
    "faq": [
      {
        "question": "What is an Agentic Life Operating System?",
        "answer": "It is a personal AI system that helps you manage your entire life—scheduling deep work, tracking health and sleep, managing digital finances, and organizing your notes—so you can focus on creative work without administrative stress."
      },
      {
        "question": "What is the Personal Data Mesh?",
        "answer": "It is a private data architecture that connects your health data (Apple Watch/Oura), your calendar, your finances, and your research notes into one secure, searchable database."
      },
      {
        "question": "How do agents protect your focus and time?",
        "answer": "By acting as an intelligent buffer: filtering out unimportant emails, declining low-value meetings, scheduling deep-work blocks, and preparing research summaries before you sit down to work."
      },
      {
        "question": "Is personal life data sent to public AI clouds?",
        "answer": "No. Sovereign life operating systems use local-first encrypted storage (like SQLite and local Markdown files) so your private journals, finances, and health data remain 100% on your own devices."
      },
      {
        "question": "What is the \"Human Soul + Machine Muscle\" philosophy?",
        "answer": "It is the core FrankX principle: humans provide the consciousness, vision, purpose, empathy, and taste (the Soul); AI agents provide the automated speed, coding, and formatting execution (the Muscle)."
      }
    ],
    "relatedDomains": [
