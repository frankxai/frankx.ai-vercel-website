...
export const researchDomains: ResearchDomain[] = [
  ...
  },
  {
    ...
    title: 'Native Image Samples',
    subtitle: 'Still-life trio plus four Grok Imagine studies. Only QA-pass frames.',
    description:
      'First-party media eval. Same still-life on Grok Imagine, Codex image_gen, and Antigravity generate_image (16 Aug 2026). Four more Grok Imagine studies (photoreal street, gold hall, original anime, collectible droid) from the same session. Missed interior/droid briefs from 15 Aug are not shown. FAL was not used.',
    tldr:
      'Three native still-lifes published. Four more Grok Imagine studies published. Earlier missed briefs stay off the page. Grok video not run. Quality id still did not appear in the tool result.',
    icon: 'Image',
    color: 'teal',
    category: 'models-tools',
    highlights: [
      { stat: '3', label: 'Native still-life paths', source: 'Grok / Codex / AGY' },
      { stat: '4', label: 'Extra Grok studies', source: 'Same session' },
      { stat: '0', label: 'FAL runs', source: 'Not used' },
      { stat: '16 Aug', label: 'Receipt date', source: 'image-curated-2026-08-16' },
    ],
    sections: [
      {
        ...
        items: [
          ...
          { title: 'Show only QA-pass frames', description: 'Missed briefs stay off the public page.', badge: 'Release' },
        ],
      },
      {
        title: 'Results',
        content: 'All three still-life paths published. Four extra Grok Imagine studies published. An earlier empty-room brief added a chair and a lamp that looked on. An earlier mechanical-droid brief became a mascot. Those two stay off this page.',
        items: [
          { title: 'Still-life trio', description: 'Grok, Codex, and Antigravity. Gold ring present. No type.', badge: 'Pass' },
          { title: 'Style studies', description: 'Rain street, gold hall, original anime, collectible droid.', badge: 'Pass' },
          { title: '15 Aug interior / mechanical droid', description: 'Missed the brief. Not shown.', badge: 'Held back' },
        ],
      },
    ],
    keyFindings: [
      'Grok Imagine is a separate image backend from Grok 4.6 text',
      'Codex and Antigravity both have native image generation',
      'Configured quality model id was not the runtime model in this session',
      'Missed briefs should not be published as a bake-off',
    ],
    faq: [
      { question: 'Did you compare FAL or Nano Banana?', answer: 'No. This page is native tools that returned pixels. FAL was not used.' },
      { question: 'Is this a Model Arena round?', answer: 'No. Model Arena is receipt-gated text and agent cards. This is a media eval with its own receipt.' },
      { question: 'Where are the files?', answer: '/research/image-curated-2026-08-16/ plus receipt.json. Frames also render on this page.' },
    ],
    ...
    status: 'active',
    evidenceGrade: 'B',
    evidenceNote: 'First-party n=1 still-life on three native tools, plus four Grok Imagine studies. Receipt at /research/image-curated-2026-08-16/receipt.json.',
    limitations: [
      'Single sample per prompt',
      'No seed control',
      'Grok quality id not isolated',
    ],
    whatWeDontKnow: [
      'Whether grok-imagine-image-quality changes these briefs',
      'How a video pass would look; it was not run',
    ],
