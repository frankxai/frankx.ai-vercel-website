...
export const researchDomains: ResearchDomain[] = [
  ...
  {
    slug: 'frontier-llm-landscape-2026',
    title: 'Frontier LLM Landscape 2026',
    subtitle: 'Models, benchmarks, agentic stacks — refreshed after every major release',
    description: 'A continuously updated map of the frontier LLM landscape: Anthropic, OpenAI, Google DeepMind, xAI, Meta, Mistral, DeepSeek, Cohere, Alibaba Qwen. Flagship models, benchmark deltas, pricing structures, and the agentic platforms that turn raw model capability into production work. Synchronised with the FrankX model registry; post-Google-I/O ’26 snapshot.',
    tldr: 'No single LLM wins every job in 2026. Gemini 3.5 Flash (I/O ’26, May 20) leads agentic coding (Terminal-Bench 2.1 76.2%, MCP Atlas 83.6%) at less than half the cost of comparable flagships. Claude Opus 4.6 leads abstract reasoning (ARC-AGI-2 68.8%) and high-stakes synthesis with a 1M-token beta context. GPT-5.2 Pro leads broad multimodal + voice. Gemini Omni adds frontier video generation. DeepSeek V3.2 anchors the budget ceiling under MIT license. The agentic layer (Antigravity 2.0, Claude Code, Cursor, Codex, Gemini Spark) is where the real production differentiation now happens — not in the model alone.',
    icon: 'Cpu',
    color: 'cyan',
    category: 'models-tools',
    highlights: [
      { stat: '76.2%', label: 'Gemini 3.5 Flash Terminal-Bench 2.1', source: 'Google I/O ’26' },
      { stat: '68.8%', label: 'Claude Opus 4.6 ARC-AGI-2 (#1)', source: 'ARC Prize' },
      { stat: '1656', label: 'Gemini 3.5 Flash GDPval-AA Elo', source: 'Google I/O ’26' },
      { stat: '<50%', label: 'Gemini 3.5 Flash cost vs comparable flagships', source: 'Google Cloud blog' },
    ],
    sections: [
      {
        title: 'The 2026 frontier (post Google I/O ’26)',
        content: 'May 20, 2026 reshuffled the deck. Google shipped Gemini 3.5 Flash with frontier benchmark numbers at sub-flagship pricing, announced Gemini 3.5 Pro for mid-June, previewed Gemini Omni (native video generation), and turned Antigravity into a full enterprise agent platform with Spark as a 24/7 personal agent. Anthropic still leads pure reasoning with Opus 4.6 + Agent Teams; OpenAI still leads voice + multimodal breadth with GPT-5.2 Pro.',
        items: [
          { title: 'Gemini 3.5 Flash', description: '76.2% Terminal-Bench 2.1, 83.6% MCP Atlas, 84.2% CharXiv — at less than half the cost of comparable flagships. The new default agentic runtime.', badge: 'I/O ’26' },
          { title: 'Gemini 3.5 Pro', description: 'Higher-tier complement to Flash. Shipping mid-June. Currently in testing.', badge: 'Preview' },
          { title: 'Gemini Omni', description: 'Native video generation from text/audio/image/video inputs. Targets enterprise post-production, virtual try-ons, personalised narratives.', badge: 'Preview' },
          { title: 'Claude Opus 4.6', description: 'ARC-AGI-2 68.8%, BigLaw Bench 90.2%, 1M-token beta context, Agent Teams, Compaction API.', badge: 'Reasoning #1' },
          { title: 'GPT-5.2 Pro', description: 'First 90% ARC-AGI-1, native audio modality, broadest enterprise integrations.', badge: 'Multimodal' },
          { title: 'Grok 4.1', description: '#1 LMArena Elo (1483) with 2M context and aggressive pricing.', badge: 'Long-context' },
        ],
      },
      {
        title: 'The agentic platform layer',
        content: 'Model differentiation increasingly happens in the agentic runtime, not the raw benchmarks. Three lineages now compete for the enterprise agent loop.',
        items: [
          { title: 'Google Antigravity 2.0', description: 'Desktop app + CLI + Agent Platform integration. Agents stay inside the Google Cloud trust boundary by default.', badge: 'Google' },
          { title: 'Claude Code + Agent SDK', description: 'Terminal-native agentic coding with parallel Agent Teams, MCP, and the Compaction API for infinite conversations.', badge: 'Anthropic' },
          { title: 'OpenAI Codex + Operator', description: 'GPT-5 series in the terminal and the browser. Strong long-running computer-use.', badge: 'OpenAI' },
          { title: 'Cursor', description: 'Frontier-model-agnostic agentic IDE — the cross-vendor execution layer.', badge: 'Third-party' },
          { title: 'Gemini Spark', description: '24/7 personal agent across Workspace, custom connectors, open web — multi-step workflows with user approval gates.', badge: 'I/O ’26' },
        ],
      },
      {
        title: 'Cost & sovereignty pressure',
        content: 'Two structural forces reshape buyer choice in 2026: an aggressive cost curve from Chinese open-weight labs (DeepSeek, Qwen) and rising data-sovereignty requirements (EU AI Act, sector-specific residency).',
        items: [
          { title: 'DeepSeek V3.2', description: '671B/37B MoE under MIT license at $0.27/$1.10 per 1M tokens. Most cost-effective frontier-class model.', badge: 'Budget' },
          { title: 'Qwen3-Coder-Next', description: '70.6% SWE-bench at only 3B active parameters, Apache 2.0. Efficiency breakthrough.', badge: 'Open' },
          { title: 'Mistral Large 3', description: 'Paris-based, full EU residency, Apache 2.0 small models with commercial Large tier.', badge: 'EU' },
          { title: 'Cohere Command A', description: 'EU residency available, enterprise RAG primitives, Toronto-based.', badge: 'Enterprise EU' },
        ],
      },
      {
        title: 'How to pick — practitioner heuristics',
        content: 'No single winner. Pick by job, not brand. The frontier is now narrow enough that workflow integration and cost dominate over benchmark deltas.',
      },
    ],
    faq: [
      { question: 'Which LLM should I default to in 2026?', answer: 'Default Gemini 3.5 Flash for cost-sensitive agentic workloads (76.2% Terminal-Bench 2.1 at sub-flagship pricing), Claude Opus 4.6 for high-stakes reasoning and long-context synthesis (1M-token beta), GPT-5.2 Pro for voice and broadest multimodal. Use DeepSeek V3.2 to anchor pricing.' },
      { question: 'What changed at Google I/O ’26?', answer: 'Five things: Gemini 3.5 Flash shipped (frontier benchmarks at sub-flagship cost), Gemini 3.5 Pro announced for mid-June, Gemini Omni previewed for native video generation, Antigravity 2.0 launched as enterprise agent platform with desktop + CLI, and Gemini Spark launched as a 24/7 personal agent.' },
      { question: 'Which frontier model is best for agentic coding?', answer: 'Two contenders. Gemini 3.5 Flash leads Terminal-Bench 2.1 (76.2%) and MCP Atlas (83.6%) at low cost. Claude Opus 4.6 leads OSWorld (72.7%) and offers Agent Teams for parallel execution. Pair Flash for high-volume agent runs with Opus for the critical reasoning path.' },
      { question: 'Is there an EU-sovereign frontier model?', answer: 'Mistral Large 3 (Paris, full EU residency) and Cohere Command A (EU residency available) are the closest to pure-frontier with EU data residency. Anthropic Opus 4.6 is available on AWS Bedrock with EU region options.' },
      { question: 'How is this kept current?', answer: 'The FrankX model registry (data/model-registry.json) is the source of truth. Every frontier release triggers the /new-model workflow within 48 hours. This domain reflects the May 20, 2026 snapshot.' },
    ],
    keyFindings: [
      'Gemini 3.5 Flash sets a new cost/intelligence frontier at less than half the cost of comparable flagships (Google I/O ’26)',
      'Claude Opus 4.6 still leads pure reasoning (ARC-AGI-2 68.8%) and high-stakes synthesis with 1M-token beta context',
      'Gemini Omni introduces native frontier-class video generation into the standard Gemini API surface',
      'Antigravity 2.0 brings Google into a head-to-head agentic platform contest with Claude Code, Cursor, and OpenAI Codex',
      'Gemini Spark redefines the personal-agent UX: 24/7 background execution across Workspace, connectors, and the open web with user approval gates',
      'DeepSeek V3.2 anchors the cost ceiling under MIT license; Qwen3-Coder-Next proves frontier coding at 3B active parameters under Apache 2.0',
      'The agentic platform layer (not the raw model) is now the primary point of buyer differentiation',
    ],
    relatedDomains: ['agent-benchmarks', 'enterprise-ai', 'multi-agent-systems', 'production-patterns', 'coding-assistants'],
    relatedBlogPosts: [
      '/blog/google-io-26-cloud-innovations-gemini-3-5-omni-antigravity',
      '/blog/frontier-model-landscape-2026-claude-gpt-gemini-deepseek',
      '/blog/claude-opus-4-6-analysis-2026',
    ],
    ...
    evidenceGrade: 'B',
    limitations: [
      'Many I/O ’26 benchmark figures (Terminal-Bench 2.1, GDPval-AA Elo, MCP Atlas, CharXiv) are vendor-published and not yet independently reproduced',
      'Gemini 3.5 Pro is in testing — full benchmark profile not yet public',
      'Cross-vendor benchmark comparisons remain difficult because evaluation protocols differ',
      'Production performance often diverges from benchmark performance — workflow integration matters more than raw scores',
    ],
    whatWeDontKnow: [
      'How Gemini 3.5 Flash benchmarks hold up under independent reproduction',
      'Whether Gemini 3.5 Pro benchmarks will exceed Opus 4.6 on ARC-AGI-2 / OSWorld at GA',
      'How Gemini Omni video generation compares to Veo 3 / Sora 2 in head-to-head editorial workflows',
      'Adoption curve and lock-in dynamics of Antigravity 2.0 vs Claude Code vs Codex across enterprise teams',
    ],
