    ...
    if (pageEntry) {
      ...
      try {
        ...
        sitemap =
          ...
          !/\brobots\s*:\s*\{[\s\S]*?\bindex\s*:\s*false\b/.test(source)
      } catch {
...
export function enumerateRoutes() {
  ...
  // 9b. Tallinn experience concepts. These slugs are backed by generateStaticParams,
  // but remain unlisted/noindex until the pilot is approved.
  routes.push(
