  ...
  theme: {
    extend: {
      colors: {
        ...
        // Used on /on-god/, /on-reality/, /on-consciousness/, /on-faith/, /canon/, /study/
        // Same dark foundation; warmer cream ink for slow reading
      ...
      fontFamily: {
        ...
        // SOURCE SERIF 4 - Contemplative-rails register (only on /on-*/ + /canon/ + /study/)
