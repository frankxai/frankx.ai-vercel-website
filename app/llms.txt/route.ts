...
- [Agent Arena](${SITE_URL}/agent-arena): Standardized 5-Gauntlet empirical benchmark for AI coding agents & harnesses
...
- [Agent Arena JSON](${SITE_URL}/agent-arena.json): Machine-readable agent benchmark scores and receipts
