...
export default function WorkEngagementNotFound() {
  return (
    <main className="relative isolate flex min-h-[75vh] items-center overflow-hidden bg-[#080808] px-6 py-24 text-white">
      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(16,185,129,0.12),transparent_45%)]"
      />
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/work"
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-emerald-400 px-6 py-3 text-sm font-semibold text-black transition-colors hover:bg-emerald-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-300 focus-visible:ring-offset-2 focus-visible:ring-offset-[#080808]"
          >
