...
const platformLayers = [
  ...
  },
  {
    ...
    detail: 'Secure database and object storage handle inquiries, tickets, renter sessions, documents, approvals, audit events, tenant RLS posture, and sanitized owner notification handoffs.',
    icon: Database,
  },
  {
