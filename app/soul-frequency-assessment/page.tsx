    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <main className="pt-28 pb-24 px-6">
        <section className="max-w-6xl mx-auto grid lg:grid-cols-[1.1fr,0.9fr] gap-12 items-start">
          <div>
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-300 text-sm font-semibold">
              <Sparkles className="w-4 h-4 text-violet-400" /> Soul Frequency Assessment
            </span>
            ...
            <div className="mt-10 grid sm:grid-cols-3 gap-6">
              {pillars.map((pillar) => (
                <div key={pillar.title} className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-5 shadow-sm backdrop-blur-md">
                  <pillar.icon className="w-8 h-8 text-violet-400 mb-3" />
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white rounded-lg transition-colors font-semibold shadow-[0_0_30px_rgba(139,92,246,0.3)]"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-slate-900/80 text-violet-300 border border-violet-500/30 rounded-lg hover:bg-slate-800 transition-colors font-semibold"
              >
                Talk with Frank
              </Link>
            </div>
          ...
          <div className="bg-slate-900/70 shadow-2xl rounded-2xl p-8 border border-slate-800/80 backdrop-blur-md">
            ...
            <ul className="space-y-4">
              {bonuses.map((bonus) => (
                <li key={bonus} className="flex items-start gap-3 text-slate-300">
            ...
            <div className="mt-8 rounded-xl bg-gradient-to-r from-violet-900/60 to-slate-900/80 border border-violet-700/40 text-white p-6">
              <h3 className="text-lg font-semibold mb-2 text-violet-200">Frequency Labs Access</h3>
            ...
            <div className="mt-8 text-sm text-slate-400">
              <p className="flex items-center gap-2">
                <Waves className="w-4 h-4 text-violet-400" /> Designed for creators, leaders, and families navigating the intelligence era.
              </p>
              <p className="flex items-center gap-2 mt-2">
                <Sparkles className="w-4 h-4 text-violet-400" /> Average completion time: 7 minutes. Delivery email within 15 minutes.
              </p>
            </div>
          </div>
        </section>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-5xl mx-auto bg-slate-900/60 border border-slate-800/80 rounded-2xl p-10 shadow-lg backdrop-blur-md">
          <h2 className="text-3xl font-bold text-white mb-6">How the Assessment Works</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="bg-slate-950/60 rounded-xl p-6 border border-slate-800/60">
                <div className="text-sm font-semibold text-violet-400">Step {item.step}</div>
                <div className="text-xl font-semibold text-white mt-2">{item.title}</div>
