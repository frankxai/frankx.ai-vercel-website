...
export const metadata: Metadata = createMetadata({
  ...
  description:
    'Connect with Frank X. Riemer. AI Architect. Creator of 12K+ songs with Suno. Get the Creative AI Toolkit, explore Vibe OS, join the Inner Circle, and access all resources.',
  path: '/links',
  keywords: [
    'frank x riemer',
    'frankx',
