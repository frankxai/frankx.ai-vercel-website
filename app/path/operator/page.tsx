        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          <div className="flex flex-col items-start gap-4">
            <TrackingLink
              ...
              className="group inline-flex items-center gap-2 rounded-2xl bg-blue-500 hover:bg-blue-600 text-white px-8 h-14 text-sm font-medium shadow-lg shadow-blue-500/20 transition-[background-color,box-shadow,transform] hover:shadow-xl hover:shadow-blue-500/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0b] active:scale-[0.98]"
            >
