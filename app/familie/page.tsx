...
const familieLinks = [
  {
    title: 'Stammbaum',
    description: 'Die Gorte- und Riemer-Familienlinien erkunden. Von Christian Riemer in Karaganda bis heute in Amsterdam.',
  ...
  },
  {
    ...
    description: 'Wolgadeutsche, Trudarmee, Karaganda — die Geschichte unserer Vorfahren. Allgemein und persönlich.',
  ...
  },
  {
    ...
    description: 'Gesammelte Erinnerungen, Weisheiten und Geschichten aus der ganzen Familie. Ein wachsendes Archiv.',
    href: '/familie#geschichten',
    icon: BookOpen,
...
export default function FamilieHubPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0b]">
      ...
      {/* Geschichten Platzhalter */}
      <section id="geschichten" className="mx-auto max-w-4xl px-6 py-20">
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8 text-center">
          <MessageCircle className="mx-auto mb-4 h-10 w-10 text-white/20" />
          <h2 className="mb-2 text-xl font-semibold text-white">Familiengeschichten</h2>
          <p className="mb-6 text-white/40">
            Hier werden gesammelte Geschichten, Erinnerungen und Weisheiten leben.
            Teile deine Geschichten über die Eingabeaufforderungen auf der{' '}
