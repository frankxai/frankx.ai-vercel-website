...
import type { GeschichteThema } from '@/lib/familie/geschichte-themen'
    ...
    <main className="min-h-screen bg-[#0a0a0b]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 pb-12 pt-28 sm:pt-32">
          ...
          <motion.p {...fadeUp(0.1)} className="mb-8 max-w-3xl font-serif text-lg leading-relaxed text-white/50">
            {thema.untertitel}
          </motion.p>
