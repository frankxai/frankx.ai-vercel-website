      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        >
          ...
          <h2 className="mb-4 font-serif text-2xl font-semibold text-white sm:text-3xl">
            Christian Riemer — Der rote Faden
          </h2>
          <p className="mb-6 max-w-3xl font-serif text-base leading-relaxed text-white/50">
            Christian Riemer wurde 1914 in Karaganda, Kasachstan geboren. Wolgadeutscher
            Abstammung. Trudarmee-Überlebender. Vater von Alexander, Großvater von
            Witali, Urgroßvater von Frank. Sein Leben verbindet alle Themen dieser
            Geschichte — von den deutschen Kolonien an der Wolga über die Deportation
            nach Kasachstan bis zum Neuanfang in Deutschland.
          </p>
          <Link
