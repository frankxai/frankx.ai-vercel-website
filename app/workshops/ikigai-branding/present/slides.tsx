...
export const SLIDES: SlideDef[] = [
  ...
  // ─── 1. Why listen — with receipts ───────────────────────────────
  {
    ...
    speakerNotes: [
      ...
      'CREDENTIAL · Read receipts aloud: "I have built CoE frameworks in large-enterprise AI contexts. Public, non-confidential patterns, open-sourced. Everything you see on the right ships on the same operating system."',
  ...
  // ─── 8. Module 3 ─────────────────────────────────────────────────
  {
    ...
    color: 'amber',
    speakerNotes: [
      'ENERGY · Quick. Three cards. Keep the explanation focused — they have Coach GPT for the extended work.',
