...
/**
 * Ikigai Workshop — V7 (Audience-Aware Synthesis)
 *
 * The honest re-think. V1's English-first structure was right. V7 keeps that
 * spine and grafts the three things V2-V6 actually got right:
 *
...
export default function IkigaiV7Page() {
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="inline-flex items-center px-2.5 py-0.5 text-[10px] font-medium rounded-full border border-violet-500/30 bg-violet-500/[0.08] text-violet-300 uppercase tracking-wider">
                V7
              </span>
            </div>
