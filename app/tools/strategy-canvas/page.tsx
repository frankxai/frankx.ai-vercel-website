          ...
          <header className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/70 max-w-3xl leading-relaxed">
                Plan your AI transformation with a comprehensive visual framework. Map stakeholders,
                resources, opportunities, and create actionable implementation roadmaps.
              </p>
            </div>
          </header>
          ...
          <section className="space-y-12">
            <div className="text-center space-y-4">
              ...
              <p className="text-xl text-white/70 max-w-3xl mx-auto">
                Pre-built templates for different organization types and use cases. Start with a framework
