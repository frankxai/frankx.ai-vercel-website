      ...
      <div className="relative z-10">
        ...
        <section className="py-12">
          <div className="max-w-6xl mx-auto px-6">
            ...
            {/* Video Learning Paths Cross-Link */}
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mt-8 mb-12 p-8 rounded-3xl bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-purple-500/10 border border-white/10 text-left relative overflow-hidden"
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                <div className="max-w-xl">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-400 text-xs font-medium mb-3">
                  ...
                  <p className="text-white/70 text-sm">
                    Explore our curated video courses with step-by-step playlists, key takeaways, and outcome checklists for Claude, Gemini, AI Music, and Image Gen.
                  </p>
                </div>
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/learn/claude-mastery"
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-500/20 text-amber-300 border border-amber-500/30 text-sm font-medium hover:bg-amber-500/30 transition-colors"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-sky-500/20 text-sky-300 border border-sky-500/30 text-sm font-medium hover:bg-sky-500/30 transition-colors"
                  >
