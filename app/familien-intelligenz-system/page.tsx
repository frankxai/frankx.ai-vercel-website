...
import { ArrowDown, ArrowRight, Download, FileCheck2, LockKeyhole, ShieldCheck, UsersRound } from 'lucide-react'
...
const rooms = [
  ...
  ['Familienarchiv', 'Geteiltes Wissen mit Quellen, Status, Schutzkreis und Export.', FileCheck2],
    ...
    <main className="min-h-screen overflow-hidden bg-[#080b0d] text-[#f4efe5]" lang="de">
      <section className="relative border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-32 lg:px-10 lg:pb-32 lg:pt-40">
          <p className="text-sm font-semibold text-emerald-300">Offene Grundlage · frühe Aufbauphase</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
        <div className="grid gap-10 lg:grid-cols-[.7fr_1.3fr]">
          <div>
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold tracking-[-0.03em] text-white sm:text-5xl">Vier Räume, die nicht automatisch ineinander übergehen.</h2>
      ...
      <section className="mx-auto grid max-w-7xl gap-6 px-6 py-24 lg:grid-cols-2 lg:px-10 lg:py-32">
        ...
        <article className="rounded-[1.75rem] border border-white/10 bg-[#111719] p-8">
          ...
          <p className="mt-4 leading-7 text-stone-400">Protokolle, Schemas, Skills, Vercel-Vorlage und v0-Prompt sind offen. Echte Familiendaten bleiben im privaten System der jeweiligen Familie.</p>
          <Link href="/family-intelligence-system/download" className="mt-7 inline-flex items-center gap-2 text-sm font-semibold text-amber-100 hover:text-white">Starter-Kit öffnen <ArrowRight className="h-4 w-4" aria-hidden /></Link>
        </article>
      </section>
    </main>
  )
