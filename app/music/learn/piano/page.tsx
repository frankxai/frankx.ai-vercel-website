    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-white to-amber-50/30">
      <div className="mx-auto max-w-4xl px-4 py-16 sm:py-24">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link href="/music/learn/violin" className="rounded-full bg-violet-100 px-6 py-4 text-base font-bold text-violet-700 transition hover:bg-violet-200">
            🎻 Geige lernen →
          </Link>
          <Link href="/music/learn" className="rounded-full bg-slate-100 px-6 py-4 text-base font-medium text-slate-600 transition hover:bg-slate-200">
            ← Alle Instrumente
          </Link>
