  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#090806] text-[#fff8e9]">
      <section className="relative isolate overflow-hidden px-5 pb-16 pt-28 sm:px-8 md:pb-24 md:pt-36 lg:px-12">
        <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_16%_10%,rgba(220,178,119,0.20),transparent_34%),radial-gradient(circle_at_84%_16%,rgba(28,96,73,0.22),transparent_31%),linear-gradient(135deg,#090806_0%,#15110c_48%,#07120f_100%)]" />
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.06fr_0.94fr] lg:items-center">
          ...
          <aside aria-label="What changed" className="relative rounded-[2.5rem] border border-white/10 bg-white/[0.055] p-4 shadow-[0_36px_130px_rgba(0,0,0,0.44)] backdrop-blur-2xl sm:p-5">
            <div className="rounded-[2.05rem] border border-white/[0.09] bg-black/[0.24] p-5 sm:p-7">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#ddb87f]">What changed</p>
              <h2 className="mt-3 text-3xl font-semibold tracking-tight">The work now has to travel through a team of four.</h2>
              <p className="mt-4 text-sm leading-6 text-[#fff8e9]/[0.58]">
              ...
              <dl className="mt-7 divide-y divide-white/[0.09] border-y border-white/[0.09]">
                {[
                  ...
                  <div key={number} className="grid gap-2 py-4 sm:grid-cols-[2.5rem_5.5rem_1fr] sm:items-start">
                    <dt className="font-mono text-xs text-[#ddb87f]">{number}</dt>
                    <dt className="text-xs font-semibold uppercase tracking-[0.12em] text-white/40">{label}</dt>
      ...
      <section className="px-5 py-16 sm:px-8 md:py-24 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#ddb87f]">What is visible today</p>
            ...
            <p className="mt-5 text-base leading-7 text-[#fff8e9]/[0.58]">
              ...
              return (
                <article key={signal.title} className={`py-7 md:px-7 md:py-9 ${index > 0 ? 'border-t border-white/10 md:border-t-0' : ''}`}>
                  <div className="flex items-center gap-3">
                    <span className="grid h-11 w-11 place-items-center rounded-2xl border border-[#ddb87f]/[0.22] bg-[#ddb87f]/[0.08] text-[#f1cf99]">
                      <Icon className="h-5 w-5" aria-hidden="true" />
                    </span>
                    <h3 className="text-lg font-semibold">{signal.title}</h3>
                  </div>
                  <p className="mt-4 text-sm leading-6 text-[#fff8e9]/[0.58]">{signal.detail}</p>
                </article>
              )
            })}
          </div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href={anaLinks.linkedin} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-2 rounded-full border border-white/[0.12] px-4 py-2 text-sm font-semibold text-[#fff8e9]/[0.64] transition hover:border-white/30 hover:text-[#fff8e9]">
              Ana on LinkedIn
              <ExternalLink className="h-3.5 w-3.5" aria-hidden="true" />
            </a>
            <a href={anaLinks.kitStart} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-2 rounded-full border border-white/[0.12] px-4 py-2 text-sm font-semibold text-[#fff8e9]/[0.64] transition hover:border-white/30 hover:text-[#fff8e9]">
      ...
      <section className="px-5 pb-20 sm:px-8 md:pb-28 lg:px-12">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.5rem] border border-white/10 bg-[linear-gradient(135deg,rgba(221,184,127,0.12),rgba(255,255,255,0.035),rgba(28,96,73,0.10))] lg:grid-cols-[1.1fr_0.9fr]">
          <div className="p-6 sm:p-8 lg:p-10">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#ddb87f]">The collaboration</p>
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-[#fff8e9]/[0.62]">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link href="/alliance/cecilia" className="inline-flex min-h-12 items-center gap-2 rounded-full border border-white/[0.16] bg-black/[0.15] px-5 py-3 text-sm font-semibold text-[#fff8e9]/75 transition hover:border-white/[0.35] hover:text-[#fff8e9]">
          ...
          <aside className="border-t border-white/10 bg-black/20 p-6 sm:p-8 lg:border-l lg:border-t-0 lg:p-10">
            ...
            <p className="mt-5 text-lg leading-7 text-[#fff8e9]/[0.72]">
            ...
            <div className="mt-6 flex items-center gap-2 text-sm text-[#fff8e9]/[0.48]">
