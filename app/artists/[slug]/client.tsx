...
import type { Track, Album } from '@/lib/music-multi'

interface ArtistPageClientProps {
  client: Client
  topTracks: Track[]
  albumsWithTracks: Array<{ album: Album; tracks: Track[] }>
  stats: {
    totalTracks: number
...
export function ArtistPageClient({ client, topTracks, albumsWithTracks, stats }: ArtistPageClientProps) {
    ...
    <main className="relative min-h-screen text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          style={{
            background: `radial-gradient(ellipse at center, ${client.branding.accentColor}14 0%, transparent 70%)`,
            filter: 'blur(100px)',
          }}
            ...
            <div className="grid lg:grid-cols-[1fr,1.2fr] gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl text-white/50 mb-8 max-w-lg leading-relaxed">
                  {stats.totalTracks > 0
                    ? `${stats.totalTracks} tracks across ${stats.albums} albums. ${client.branding.tagline}`
            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <p className="text-3xl md:text-4xl font-bold text-white">{stats.totalTracks}</p>
                  <p className="text-sm text-white/40 mt-1">Tracks</p>
                </div>
                <div className="text-center">
                  <p className="text-3xl md:text-4xl font-bold text-white">{stats.albums}</p>
                  <p className="text-sm text-white/40 mt-1">Albums</p>
                </div>
                {stats.totalPlays !== undefined && stats.totalPlays > 0 && (
                  <div className="text-center">
                    <p className="text-3xl md:text-4xl font-bold text-white">{stats.totalPlays}</p>
                    <p className="text-sm text-white/40 mt-1">Total Plays</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <section className="py-20">
            <div className="max-w-6xl mx-auto px-6">
              ...
              >
                ...
                <p className="text-lg text-white/50">Most played tracks from {client.artistName}</p>
              </motion.div>
          ...
          <section className="py-20 border-t border-white/5">
            <div className="max-w-6xl mx-auto px-6">
              ...
              >
                ...
                <p className="text-lg text-white/50">Curated collections by {client.artistName}</p>
              </motion.div>

              <div className="space-y-12">
                {albumsWithTracks.map(({ album, tracks }, i) => {
                    ...
                    >
                      <div className="flex items-start justify-between mb-6">
                        ...
                        {album.playlistUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 text-sm text-white/50 hover:text-white transition-colors shrink-0"
                          >
                            Full playlist
                            <ExternalLink className="w-4 h-4" />
                          </a>
                      ...
                      {tracks.length > 3 && (
                        <p className="mt-3 text-sm text-white/30 text-center">
                          + {tracks.length - 3} more tracks in this album
                        </p>
                      )}
                    </motion.div>
                  )
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Want your own music page?
              </h2>
              <p className="text-xl text-white/50 mb-8 max-w-2xl mx-auto">
                FrankX Music Service helps AI music creators package, distribute, and sell their tracks.
              </p>
              <Link
                href="/music-lab"
