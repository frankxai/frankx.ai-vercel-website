    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden min-h-[85vh] flex items-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-24 sm:py-32">
          <div
            className="text-center space-y-8 animate-fade-in-up opacity-0 motion-reduce:animate-none"
          >
            {/* Badge */}
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/20 backdrop-blur-md text-amber-200 text-sm font-medium border border-amber-400/30 animate-scale-in opacity-0 motion-reduce:animate-none"
            ...
            {/* Story Hook */}
            <div
              className="animate-fade-in opacity-0 motion-reduce:animate-none"
            ...
            {/* Stats */}
            <div
              className="flex items-center justify-center gap-8 pt-4 animate-fade-in-up opacity-0 motion-reduce:animate-none"
            ...
            {/* CTAs */}
            <div
              className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-fade-in-up opacity-0 motion-reduce:animate-none"
