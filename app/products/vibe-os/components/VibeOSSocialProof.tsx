    ...
    <section className="relative py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="mb-10 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.15em] text-cyan-300/60">
            Current product status
          </p>
          <h2 className="mt-3 text-3xl font-bold text-white">Know what is available before you begin.</h2>
        </div>

        {/* Product status supplied by the canonical product record. */}
