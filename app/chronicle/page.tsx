...
const pillars = [
  ...
  },
  {
    ...
    body: 'The implementation of the same six-pillar AI Center of Excellence framework Frank worked with in enterprise settings at Oracle, translated to personal scale.',
    href: '/acos/agents',
  },
  {
    n: '03',
