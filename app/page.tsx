...
export const metadata = createMetadata({
  title: 'FrankX — AI Architecture & Expert Intelligence Systems',
  description:
    'Frank Riemer architects owned AI intelligence systems for experts and founder-led businesses, backed by working agent systems, research, products, and a living creative studio.',
  keywords: [
    'Frank Riemer',
    'FrankX',
    'living studio',
...
const websiteSchema = {
  ...
  url: siteUrl,
  description:
    'FrankX is Frank Riemer\'s AI architecture and creative studio for expert intelligence systems, agent workflows, music, books, and practical tools.',
  publisher: {
...
const organizationSchema = {
  ...
  description:
    'FrankX publishes inspectable intelligence systems, agent-workflow labs, music, books, and practical field notes from Frank Riemer.',
}
