  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'Offer',
        name: 'Circle — Monthly',
        description: 'Full vault access, live labs every other week, monthly masterclass, prompt packs, agent template collection.',
        price: '119',
        priceCurrency: 'USD',
        priceSpecification: {
        ...
        availabilityStarts: '2026-06-01T09:00:00+02:00',
      },
      {
        '@type': 'Offer',
        name: 'Circle — Annual',
        description: 'Full vault access at annual price (~30% saving vs monthly).',
        price: '999',
        priceCurrency: 'USD',
        priceSpecification: {
          '@type': 'UnitPriceSpecification',
      ...
      {
        '@type': 'Offer',
        name: 'Founding 100 Bonus',
        description: 'First 100 to join June 1-7: founders Slack (closes June 7) + exclusive July 20 masterclass + founders rate locked at $119/month for life of subscription.',
        eligibleQuantity: {
        ...
        availability: 'https://schema.org/PreOrder',
        availabilityStarts: '2026-06-01T09:00:00+02:00',
        availabilityEnds: '2026-06-07T23:59:59+02:00',
      },
    ],
  },
}
