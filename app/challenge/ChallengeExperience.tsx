          ...
          <div>
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              <button
                ...
                className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-white px-7 text-sm font-bold uppercase tracking-[0.16em] text-black transition hover:-translate-y-0.5 hover:bg-cyan-100 disabled:cursor-wait disabled:opacity-70"
              >
                <CreditCard className="h-4 w-4" />
                {checkoutState === 'loading' ? 'Opening checkout…' : 'Get the Creator Kit — $47'}
                <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
              </button>
              <a
                href="#ledger"
                className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full border border-white/15 bg-white/[0.04] px-7 text-sm font-semibold uppercase tracking-[0.16em] text-white transition hover:border-white/30 hover:bg-white/[0.08]"
              >
                See the evidence
            ...
            <div className="mt-4 min-h-6 text-sm text-rose-300" aria-live="polite">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            <MetricCard
              ...
              suffix=" EUR"
              detail={'Verified customer payments. The $47 checkout is normalized to the EUR settlement value when received.'}
            />
            <MetricCard
              label="Customers"
          ...
          <div className="mt-5 grid gap-5 md:grid-cols-3">
            {[
              ['Gross charged', '$' + ledger.actual.grossUsd, ReceiptEuro],
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <button
              ...
              onClick={startCheckout}
              disabled={checkoutState === 'loading'}
              className="mt-8 inline-flex min-h-14 items-center gap-3 rounded-full bg-emerald-300 px-7 text-sm font-bold uppercase tracking-[0.15em] text-[#06120e] transition hover:-translate-y-0.5 hover:bg-emerald-200 disabled:opacity-70"
            >
              {checkoutState === 'loading' ? 'Opening checkout…' : 'Get the kit — $47'}
      ...
      <section className="border-t border-white/[0.08] px-6 py-24">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-[2.5rem] border border-white/12 bg-[radial-gradient(circle_at_top_left,rgba(124,58,237,0.2),transparent_44%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.16),transparent_40%),#0a0c11] p-8 text-center shadow-[0_40px_120px_rgba(0,0,0,0.4)] sm:p-14">
          ...
          <button
            ...
            onClick={startCheckout}
            disabled={checkoutState === 'loading'}
            className="mt-10 inline-flex min-h-14 items-center gap-3 rounded-full bg-white px-8 text-sm font-bold uppercase tracking-[0.16em] text-black transition hover:-translate-y-0.5 hover:bg-cyan-100 disabled:opacity-70"
          >
            {checkoutState === 'loading' ? 'Opening checkout…' : 'Start with ACOS — $47'}
            <ArrowRight className="h-4 w-4" />
          </button>
