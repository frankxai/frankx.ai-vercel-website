...
const templates: Template[] = [
  {
    ...
    features: [
      ...
      'OCI Enterprise AI variant note',
  ...
  {
    id: 'agent-payments-guard',
    dir: 'agent-payments-guard',
    title: 'Agent Payments Guard',
    subtitle: 'Fail-closed payments governance — your agent gets a gate, not a transfer tool',
    icon: ShieldCheck,
    color: 'cyan',
    features: [
      '4 verify-only MCP tools — none moves money, by design',
      'Ed25519 mandate verification with replay protection',
      'Operator-owned spend caps (per-transaction / per-day)',
      'Append-only audit log — verdicts fail if the write fails',
      'Over-cap actions escalate to a human, never auto-approve',
      '20 fail-closed tests, 2 runtime dependencies',
    ],
    techStack: ['TypeScript', 'MCP SDK', 'zod', 'node:crypto'],
    includesOCI: false,
    deployable: false,
  },
  {
