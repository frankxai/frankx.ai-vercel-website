...
const instruments = [
  ...
  {
    name: 'Drum Machine',
    description: '808 step sequencer. 8 synthesized drum sounds, 16-step grid, adjustable BPM. Program your own beats.',
  ...
  {
    name: 'Piano for Kids',
    description: 'One colorful octave — each key has its own color and note name. Perfect for learning.',
  ...
  {
    name: 'Drums for Kids',
    description: '6 big colorful drums to tap. Kick, snare, hi-hat, toms, and cymbal. Make some noise!',
