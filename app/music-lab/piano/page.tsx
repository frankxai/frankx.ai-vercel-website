  ...
  return (
    <div className="bg-[#060810] min-h-[100dvh] flex flex-col overflow-hidden select-none">
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute w-80 h-80 bg-purple-500/[0.02] rounded-full blur-[128px] bottom-1/3 right-1/4" />
        <div className="absolute w-60 h-60 bg-blue-500/[0.015] rounded-full blur-[128px] top-1/2 left-1/4" />
      </div>
