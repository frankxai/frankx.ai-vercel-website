...
export default function FamilyTreeV15Inner() {
  ...
  const layoutPositions: Record<LayoutMode, LayoutPositions> = {
    tree: {
      'example-maternal-grandparent-a': { x: 150, y: 80 },
      'example-maternal-grandparent-b': { x: 250, y: 80 },
      'example-paternal-grandparent-a': { x: 550, y: 80 },
      'example-paternal-grandparent-b': { x: 650, y: 80 },
      'example-parent-a': { x: 200, y: 250 },
      'example-parent-b': { x: 600, y: 250 },
      'example-focus-person': { x: 400, y: 450 },
      'example-partner': { x: 500, y: 450 },
    },
    radial: {
      'example-focus-person': { x: 400, y: 300 },
      'example-partner': { x: 500, y: 300 },
      'example-parent-a': { x: 280, y: 200 },
      'example-parent-b': { x: 620, y: 200 },
      'example-maternal-grandparent-a': { x: 200, y: 100 },
      'example-maternal-grandparent-b': { x: 200, y: 300 },
      'example-paternal-grandparent-a': { x: 600, y: 100 },
      'example-paternal-grandparent-b': { x: 700, y: 200 },
    },
    grid: {
      'example-maternal-grandparent-a': { x: 200, y: 100 },
      'example-maternal-grandparent-b': { x: 400, y: 100 },
      'example-paternal-grandparent-a': { x: 600, y: 100 },
      'example-paternal-grandparent-b': { x: 200, y: 250 },
      'example-parent-a': { x: 400, y: 250 },
      'example-parent-b': { x: 600, y: 250 },
      'example-focus-person': { x: 400, y: 400 },
      'example-partner': { x: 600, y: 400 },
    },
  }
