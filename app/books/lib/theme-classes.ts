...
const themeMap: Record<string, ThemeClasses> = {
  ...
  coherence: {
    progressGradient: 'bg-gradient-to-r from-cyan-400 via-sky-400 to-violet-500',
    textPrimary: 'text-cyan-300',
    textAccent: 'text-violet-300',
    borderPrimary: 'border-cyan-400',
    borderAccent: 'border-violet-500',
    bgPrimary: 'bg-cyan-400/10',
    bgAccent: 'bg-violet-500/10',
    bgPage: 'bg-[#070b12]',
    blockquoteBorder: 'border-cyan-400',
    blockquoteBg: 'bg-cyan-900/10',
    blockquoteText: 'text-cyan-50',
    linkColor: 'text-cyan-300',
    badgeBg: 'bg-cyan-400/20',
    badgeText: 'text-cyan-200',
    badgeBorder: 'border-cyan-300/30',
    tocActive: 'bg-cyan-400/20 text-cyan-200',
    hoverBorder: 'hover:border-cyan-400',
    hoverRing: 'focus:ring-cyan-400/50',
    gradientText: 'bg-gradient-to-r from-cyan-200 via-sky-200 to-violet-300 bg-clip-text text-transparent',
  },
  'the-wordless-laws': {
    progressGradient: 'bg-gradient-to-r from-indigo-500 via-violet-500 to-amber-400',
    ...
    blockquoteText: 'text-indigo-50',
    linkColor: 'text-amber-300',
    badgeBg: 'bg-indigo-500/20',
    badgeText: 'text-indigo-200',
    badgeBorder: 'border-indigo-400/30',
    tocActive: 'bg-indigo-500/20 text-indigo-100',
    hoverBorder: 'hover:border-indigo-500',
    hoverRing: 'focus:ring-indigo-500/50',
    gradientText: 'bg-gradient-to-r from-indigo-200 via-violet-200 to-amber-200 bg-clip-text text-transparent',
  },
  'the-wordless-laws-book-two': {
    progressGradient: 'bg-gradient-to-r from-amber-400 via-yellow-300 to-indigo-500',
    textPrimary: 'text-amber-300',
    textAccent: 'text-indigo-300',
    borderPrimary: 'border-amber-400',
    borderAccent: 'border-indigo-500',
    ...
    blockquoteBorder: 'border-amber-400',
    blockquoteBg: 'bg-amber-900/10',
    blockquoteText: 'text-amber-50',
    linkColor: 'text-amber-300',
    badgeBg: 'bg-amber-400/20',
    badgeText: 'text-amber-200',
    badgeBorder: 'border-amber-300/30',
    tocActive: 'bg-amber-400/20 text-amber-100',
    hoverBorder: 'hover:border-amber-400',
    hoverRing: 'focus:ring-amber-400/50',
    gradientText: 'bg-gradient-to-r from-amber-200 via-yellow-100 to-indigo-200 bg-clip-text text-transparent',
  },
};
