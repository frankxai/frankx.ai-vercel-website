...
const themeMap: Record<string, ThemeClasses> = {
  ...
  'the-book-of-secrets': {
    progressGradient: 'bg-gradient-to-r from-teal-500 via-cyan-400 to-amber-300',
    textPrimary: 'text-teal-300',
    textAccent: 'text-amber-300',
    borderPrimary: 'border-teal-500',
    borderAccent: 'border-amber-500',
    bgPrimary: 'bg-teal-500/10',
    bgAccent: 'bg-amber-500/10',
    bgPage: 'bg-[#060b0b]',
    blockquoteBorder: 'border-amber-400',
    blockquoteBg: 'bg-teal-900/10',
    blockquoteText: 'text-teal-50',
    linkColor: 'text-amber-300',
    badgeBg: 'bg-teal-500/20',
    badgeText: 'text-teal-200',
    badgeBorder: 'border-teal-400/30',
    tocActive: 'bg-teal-500/20 text-teal-100',
    hoverBorder: 'hover:border-teal-500',
    hoverRing: 'focus:ring-teal-500/50',
    gradientText: 'bg-gradient-to-r from-teal-200 via-cyan-200 to-amber-200 bg-clip-text text-transparent',
  },
};
