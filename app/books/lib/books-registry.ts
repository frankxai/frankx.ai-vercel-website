...
export const booksRegistry: BookConfig[] = [
  ...
  },
  {
    slug: 'coherence',
    title: 'Coherence',
    subtitle: 'The Unified Field of Consciousness That Creates Reality',
    author: 'Frank',
    publishDate: '2026',
    description:
      'Book One of Inner Architecture. Every tradition pointed at one state; now we can measure it. The science-grounded guide to coherence — where heart, breath, attention, and intention pull in one direction — and the trainable skill beneath every human-potential promise.',
    keywords: ['coherence', 'heart rate variability', 'breathwork', 'nervous system', 'meditation', 'human potential', 'predictive brain', 'expectation effect'],
    coverImage: '',
    theme: {
      id: 'coherence',
      name: 'Coherence',
